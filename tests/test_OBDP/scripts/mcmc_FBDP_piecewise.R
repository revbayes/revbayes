...
observed_phylogeny <- readTrees("output_expected/mcmc_FBDP_mcc_piece.tre")[1]
...
fbd_tree ~ dnFBDP(origin=origin_time , lambda=speciation, mu=extinction, psi=speciation, timeline=interval_times, rho=1.0, taxa=taxa, initialTree=observed_phylogeny)
...
monitors[2] = mnScreen(printgen=100000, num_samp_anc, num_tips)
