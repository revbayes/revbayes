...
/* Default constructor */
Integer::Integer(void) : ModelObject<int64_t>()
{
    
}


Integer::Integer( RevBayesCore::TypedDagNode<int64_t> *v ) : ModelObject<int64_t>( v )
{
...
Integer::Integer(int64_t v) : ModelObject<int64_t>( new int64_t(v) )
{
...
RevObject* Integer::add( const RevObject& rhs ) const 
{
    ...
    return ModelObject<int64_t>::add( rhs );
}
...
RevObject* Integer::divide( const RevObject& rhs ) const 
{
    ...
    return ModelObject<int64_t>::divide( rhs );
}
...
RevObject* Integer::multiply( const RevObject& rhs ) const 
{
    ...
    return ModelObject<int64_t>::multiply( rhs );
}
...
RevObject* Integer::subtract( const RevObject& rhs ) const 
{
    ...
    return ModelObject<int64_t>::subtract( rhs );
}
