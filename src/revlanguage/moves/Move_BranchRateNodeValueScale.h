#ifndef Move_BranchRateNodeValueScale_H
#define Move_BranchRateNodeValueScale_H
...
namespace RevLanguage {
     ...
     *
     */
    class Move_BranchRateNodeValueScale : public Move {
        
    public:
        
        Move_BranchRateNodeValueScale(void);                                                                                                                       //!< Default constructor
        
        // Basic utility functions
        virtual Move_BranchRateNodeValueScale*      clone(void) const;                                                                          //!< Clone object
