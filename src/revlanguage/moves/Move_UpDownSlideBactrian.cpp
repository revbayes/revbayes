 ...
 */
Move_UpDownSlideBactrian::Move_UpDownSlideBactrian() : Move()
{
 ...
 */
Move_UpDownSlideBactrian* Move_UpDownSlideBactrian::clone(void) const
{
    
    return new Move_UpDownSlideBactrian(*this);
}
 ...
 */
void Move_UpDownSlideBactrian::constructInternalObject( void )
{
...
RevPtr<RevVariable> Move_UpDownSlideBactrian::executeMethod(const std::string& name, const std::vector<Argument>& args, bool &found)
{
 ...
 */
const std::string& Move_UpDownSlideBactrian::getClassType(void)
{
    
    static std::string rev_type = "Move_UpDownSlideBactrian";
 ...
 */
const TypeSpec& Move_UpDownSlideBactrian::getClassTypeSpec(void)
{
 ...
 */
std::string Move_UpDownSlideBactrian::getMoveName( void ) const
{
    // create a constructor function name variable that is the same for all instance of this class
    std::string c_name = "UpDownSlideBactrian";
 ...
 */
const MemberRules& Move_UpDownSlideBactrian::getParameterRules(void) const
{
 ...
 */
const TypeSpec& Move_UpDownSlideBactrian::getTypeSpec( void ) const
{
...
void Move_UpDownSlideBactrian::printValue(std::ostream &o) const
{
    
    o << "Move_UpDownSlideBactrian(?)";
 ...
 */
void Move_UpDownSlideBactrian::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
