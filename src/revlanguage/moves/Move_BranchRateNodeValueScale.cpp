 ...
 */
Move_BranchRateNodeValueScale::Move_BranchRateNodeValueScale() : Move()
{
 ...
 */
Move_BranchRateNodeValueScale* Move_BranchRateNodeValueScale::clone(void) const
{

    return new Move_BranchRateNodeValueScale(*this);
}
 ...
 *
 */
void Move_BranchRateNodeValueScale::constructInternalObject( void )
{
    ...
    RevBayesCore::Proposal *p = new RevBayesCore::BranchRateNodeValueScaleProposal(n, tree_node, d, r);
 ...
 */
const std::string& Move_BranchRateNodeValueScale::getClassType(void)
{

    static std::string rev_type = "Move_BranchRateNodeValueScale";
 ...
 */
const TypeSpec& Move_BranchRateNodeValueScale::getClassTypeSpec(void)
{
 ...
 */
std::string Move_BranchRateNodeValueScale::getMoveName( void ) const
{
    // create a constructor function name variable that is the same for all instance of this class
    std::string c_name = "BranchRateNodeValueScale";
 ...
 */
const MemberRules& Move_BranchRateNodeValueScale::getParameterRules(void) const
{
 ...
 */
const TypeSpec& Move_BranchRateNodeValueScale::getTypeSpec( void ) const
{
...
void Move_BranchRateNodeValueScale::printValue(std::ostream &o) const
{

    o << "BranchRateNodeValueScale(";
    if (x != NULL)
    {
        o << x->getName();
    }
 ...
 */
void Move_BranchRateNodeValueScale::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
