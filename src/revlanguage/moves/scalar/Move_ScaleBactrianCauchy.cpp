 ...
 */
Move_ScaleBactrianCauchy::Move_ScaleBactrianCauchy() : Move() 
{
 ...
 */
Move_ScaleBactrianCauchy* Move_ScaleBactrianCauchy::clone(void) const 
{
    
	return new Move_ScaleBactrianCauchy(*this);
}
 ...
 */
void Move_ScaleBactrianCauchy::constructInternalObject( void ) 
{
    ...
    RevBayesCore::Proposal *p = new RevBayesCore::ScaleBactrianCauchyProposal(n, d, r);
 ...
 */
const std::string& Move_ScaleBactrianCauchy::getClassType(void) 
{ 
    
    static std::string rev_type = "Move_ScaleBactrianCauchy";
 ...
 */
const TypeSpec& Move_ScaleBactrianCauchy::getClassTypeSpec(void) 
{ 
 ...
 */
std::string Move_ScaleBactrianCauchy::getMoveName( void ) const
{
    // create a constructor function name variable that is the same for all instance of this class
    std::string c_name = "ScaleBactrianCauchy";
 ...
 */
const MemberRules& Move_ScaleBactrianCauchy::getParameterRules(void) const 
{
 ...
 */
const TypeSpec& Move_ScaleBactrianCauchy::getTypeSpec( void ) const 
{
...
void Move_ScaleBactrianCauchy::printValue(std::ostream &o) const
{
 ...
 */
void Move_ScaleBactrianCauchy::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var) 
{
