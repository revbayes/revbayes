#ifndef Move_SliceSampling_H
#define Move_SliceSampling_H
...
namespace RevLanguage {
     ...
     * See the SliceSamplingMove.h for more details.
     *
     *
     ...
     *
     */
    class Move_SliceSampling : public Move {
        
    public:
        
        Move_SliceSampling(void);                                                                                                               //!< Default constructor
        
        // Basic utility functions
        virtual Move_SliceSampling*                 clone(void) const;                                                                          //!< Clone object
