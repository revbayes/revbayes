...
Move_SingleElementBetaSimplexAllScalarVector::Move_SingleElementBetaSimplexAllScalarVector() : Move()
{
 ...
 */
Move_SingleElementBetaSimplexAllScalarVector* Move_SingleElementBetaSimplexAllScalarVector::clone(void) const
{
    
	return new Move_SingleElementBetaSimplexAllScalarVector(*this);
}


void Move_SingleElementBetaSimplexAllScalarVector::constructInternalObject( void )
{
    ...
    RevBayesCore::Proposal *prop = new RevBayesCore::SingleElementBetaSimplexAllScalarVectorProposal(n, sv, a, r);
    value = new RevBayesCore::MetropolisHastingsMove(prop, w, t);

}


RevPtr<RevVariable> Move_SingleElementBetaSimplexAllScalarVector::executeMethod(const std::string& name, const std::vector<Argument>& args, bool &found)
{
    ...
    if ( name == "addIndex" )
    {
        ...
        RevBayesCore::SingleElementBetaSimplexAllScalarVectorProposal &prop = static_cast<RevBayesCore::SingleElementBetaSimplexAllScalarVectorProposal&>( m->getProposal() );
...
const std::string& Move_SingleElementBetaSimplexAllScalarVector::getClassType(void)
{
    
    static std::string rev_type = "Move_SingleElementBetaSimplexAllScalarVector";
...
const TypeSpec& Move_SingleElementBetaSimplexAllScalarVector::getClassTypeSpec(void)
{
 ...
 */
std::string Move_SingleElementBetaSimplexAllScalarVector::getMoveName( void ) const
{
    // create a constructor function name variable that is the same for all instance of this class
    std::string c_name = "SingleElementBetaSimplexAllScalarVector";
...
const MemberRules& Move_SingleElementBetaSimplexAllScalarVector::getParameterRules(void) const
{
    ...
    if ( !rules_set )
    {
        move_member_rules.push_back( new ArgumentRule( "simplex", Simplex::getClassTypeSpec(), "The simplex this move operates on.", ArgumentRule::BY_REFERENCE, ArgumentRule::STOCHASTIC ) );
...
/** Get type spec */
const TypeSpec& Move_SingleElementBetaSimplexAllScalarVector::getTypeSpec( void ) const
{
...
/** Get type spec */
void Move_SingleElementBetaSimplexAllScalarVector::printValue(std::ostream &o) const
{
    
    o << "Move_SingleElementBetaSimplexAllScalarVector(";
    if (x != NULL)
    {
        o << x->getName();
    }
...
void Move_SingleElementBetaSimplexAllScalarVector::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
