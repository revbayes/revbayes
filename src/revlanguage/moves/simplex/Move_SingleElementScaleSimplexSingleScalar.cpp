...
Move_SingleElementScaleSimplexSingleScalar::Move_SingleElementScaleSimplexSingleScalar() : Move()
{
 ...
 */
Move_SingleElementScaleSimplexSingleScalar* Move_SingleElementScaleSimplexSingleScalar::clone(void) const
{
    
	return new Move_SingleElementScaleSimplexSingleScalar(*this);
}


void Move_SingleElementScaleSimplexSingleScalar::constructInternalObject( void )
{
    ...
    RevBayesCore::Proposal *prop = new RevBayesCore::SingleElementScaleSimplexSingleScalarProposal(n, l, r);
    value = new RevBayesCore::MetropolisHastingsMove(prop, w, t);

}


RevPtr<RevVariable> Move_SingleElementScaleSimplexSingleScalar::executeMethod(const std::string& name, const std::vector<Argument>& args, bool &found)
{
    ...
    if ( name == "addIndex" )
    {
        ...
        RevBayesCore::SingleElementScaleSimplexSingleScalarProposal &prop = static_cast<RevBayesCore::SingleElementScaleSimplexSingleScalarProposal&>( m->getProposal() );
...
const std::string& Move_SingleElementScaleSimplexSingleScalar::getClassType(void)
{
    
    static std::string rev_type = "Move_SingleElementScaleSimplexSingleScalar";
    
	return rev_type; 
}

/** Get class type spec describing type of object */
const TypeSpec& Move_SingleElementScaleSimplexSingleScalar::getClassTypeSpec(void)
{
 ...
 */
std::string Move_SingleElementScaleSimplexSingleScalar::getMoveName( void ) const
{
    // create a constructor function name variable that is the same for all instance of this class
    std::string c_name = "SingleElementScaleSimplexSingleScalar";
...
const MemberRules& Move_SingleElementScaleSimplexSingleScalar::getParameterRules(void) const
{
...
/** Get type spec */
const TypeSpec& Move_SingleElementScaleSimplexSingleScalar::getTypeSpec( void ) const
{
...
/** Get type spec */
void Move_SingleElementScaleSimplexSingleScalar::printValue(std::ostream &o) const
{
    
    o << "Move_SingleElementScaleSimplexSingleScalar(";
    if (x != NULL)
    {
        o << x->getName();
    }
...
void Move_SingleElementScaleSimplexSingleScalar::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
