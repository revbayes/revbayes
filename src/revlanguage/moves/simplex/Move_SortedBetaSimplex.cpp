...
Move_SortedBetaSimplex::Move_SortedBetaSimplex() : Move()
{
 ...
 */
Move_SortedBetaSimplex* Move_SortedBetaSimplex::clone(void) const
{

	return new Move_SortedBetaSimplex(*this);
}


void Move_SortedBetaSimplex::constructInternalObject( void )
{
    ...
    RevBayesCore::Proposal *prop = new RevBayesCore::SortedBetaSimplexProposal(n,a,r);
...
const std::string& Move_SortedBetaSimplex::getClassType(void)
{

    static std::string rev_type = "Move_SortedBetaSimplex";

	return rev_type;
}

/** Get class type spec describing type of object */
const TypeSpec& Move_SortedBetaSimplex::getClassTypeSpec(void)
{
 ...
 */
std::vector<std::string> Move_SortedBetaSimplex::getMoveAliases( void ) const
{
 ...
 */
std::string Move_SortedBetaSimplex::getMoveName( void ) const
{
    // create a constructor function name variable that is the same for all instance of this class
    std::string c_name = "SortedBetaSimplex";
...
const MemberRules& Move_SortedBetaSimplex::getParameterRules(void) const
{
...
/** Get type spec */
const TypeSpec& Move_SortedBetaSimplex::getTypeSpec( void ) const
{
...
/** Get type spec */
void Move_SortedBetaSimplex::printValue(std::ostream &o) const
{

    o << "Move_SortedBetaSimplex(";
    if (x != NULL)
    {
        o << x->getName();
    }
...
void Move_SortedBetaSimplex::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
