#ifndef Move_BinarySwitch_H
#define Move_BinarySwitch_H
...
namespace RevLanguage {
    ...
    /**
     * The RevLanguage wrapper of the binary-switch move.
     *
     * The RevLanguage wrapper of the binary-switch move simply
     * manages the interactions through the Rev with our core.
     * That is, the internal move object can be constructed and hooked up
     * in a DAG-nove (variable) that it works on.
     * See the BinarySwitchMove.h for more details.
     *
     *
     ...
     *
     */
    class Move_BinarySwitch : public Move {
