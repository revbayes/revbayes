 ...
 */
Move_MultiValueEventSlide::Move_MultiValueEventSlide() : Move()
{
 ...
 */
Move_MultiValueEventSlide* Move_MultiValueEventSlide::clone(void) const
{
    
    return new Move_MultiValueEventSlide(*this);
}
 ...
 *
 */
void Move_MultiValueEventSlide::constructInternalObject( void )
{
 ...
 */
const std::string& Move_MultiValueEventSlide::getClassType(void)
{
    
    static std::string rev_type = "Move_MultiValueEventSlide";
 ...
 */
const TypeSpec& Move_MultiValueEventSlide::getClassTypeSpec(void)
{
 ...
 */
std::string Move_MultiValueEventSlide::getMoveName( void ) const
{
    // create a constructor function name variable that is the same for all instance of this class
    std::string c_name = "MultiValueEventSlide";
 ...
 */
const MemberRules& Move_MultiValueEventSlide::getParameterRules(void) const
{
 ...
 */
const TypeSpec& Move_MultiValueEventSlide::getTypeSpec( void ) const
{
...
void Move_MultiValueEventSlide::printValue(std::ostream &o) const
{
    
    o << "Move_MultiValueEventSlide(";
    if (x != NULL)
    {
        o << x->getName();
    }
 ...
 */
void Move_MultiValueEventSlide::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
