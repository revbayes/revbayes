...
Move_WeightedSubtreePruneAndRegraft::Move_WeightedSubtreePruneAndRegraft() : Move()
{
 ...
 */
Move_WeightedSubtreePruneAndRegraft* Move_WeightedSubtreePruneAndRegraft::clone(void) const
{
    
    return new Move_WeightedSubtreePruneAndRegraft(*this);
}


void Move_WeightedSubtreePruneAndRegraft::constructInternalObject( void )
{
...
//    bool tune = static_cast<const RlBoolean &>( tuning->getRevObject() ).getValue();
    ...
    RevBayesCore::Proposal *p = new RevBayesCore::WeightedSubtreePruneAndRegraftProposal(t, n, a);
...
const std::string& Move_WeightedSubtreePruneAndRegraft::getClassName(void)
{
    
    static std::string rbClassName = "Move_WeightedSubtreePruneAndRegraft";
    
    return rbClassName;
}

/** Get class type spec describing type of object */
const TypeSpec& Move_WeightedSubtreePruneAndRegraft::getClassTypeSpec(void)
{
...
const MemberRules& Move_WeightedSubtreePruneAndRegraft::getParameterRules(void) const
{
...
/** Get type spec */
const TypeSpec& Move_WeightedSubtreePruneAndRegraft::getTypeSpec( void ) const
{
...
/** Get type spec */
void Move_WeightedSubtreePruneAndRegraft::printValue(std::ostream &o) const
{
    
    o << "WeightedSubtreePruneAndRegraft(";
    if (tree != NULL)
    {
        o << tree->getName();
    }
...
void Move_WeightedSubtreePruneAndRegraft::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
