...
Move_SPRExtendingNonclock::Move_SPRExtendingNonclock() : Move()
{
 ...
 */
Move_SPRExtendingNonclock* Move_SPRExtendingNonclock::clone(void) const
{
    
	return new Move_SPRExtendingNonclock(*this);
}


void Move_SPRExtendingNonclock::constructInternalObject( void )
{
    ...
    RevBayesCore::Proposal *p = new RevBayesCore::SubtreePruneRegraftExtending_nonClockProposal(t, ep);
...
const std::string& Move_SPRExtendingNonclock::getClassName(void)
{
    
    static std::string rbClassName = "Move_SPRExtending";
    
	return rbClassName;
}

/** Get class type spec describing type of object */
const TypeSpec& Move_SPRExtendingNonclock::getClassTypeSpec(void)
{
 ...
 */
std::string Move_SPRExtendingNonclock::getMoveName( void ) const
{
    // create a constructor function name variable that is the same for all instance of this class
    std::string c_name = "SPRExtending";
...
const MemberRules& Move_SPRExtendingNonclock::getParameterRules(void) const
{
...
/** Get type spec */
const TypeSpec& Move_SPRExtendingNonclock::getTypeSpec( void ) const
{
...
/** Get type spec */
void Move_SPRExtendingNonclock::printValue(std::ostream &o) const
{
...
void Move_SPRExtendingNonclock::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
