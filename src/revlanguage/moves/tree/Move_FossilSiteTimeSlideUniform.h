#ifndef Move_FossilSiteTimeSlideUniform_H
#define Move_FossilSiteTimeSlideUniform_H
...
namespace RevLanguage {
     ...
     */
    class Move_FossilSiteTimeSlideUniform : public Move {
        
    public:
        
        Move_FossilSiteTimeSlideUniform(void);                                                                                               //!< Default constructor
        
        // Basic utility functions
        virtual Move_FossilSiteTimeSlideUniform*     clone(void) const;                                                                      //!< Clone object
