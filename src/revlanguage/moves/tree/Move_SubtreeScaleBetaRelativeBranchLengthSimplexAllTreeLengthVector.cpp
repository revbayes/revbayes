 ...
 */
Move_SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector::Move_SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector() : Move()
{
 ...
 */
Move_SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector* Move_SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector::clone(void) const
{
    
    return new Move_SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector(*this);
}
 ...
 */
void Move_SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector::constructInternalObject( void )
{
    ...
    RevBayesCore::Proposal *prop = new RevBayesCore::SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVectorProposal(tr, relbls, tlv, a, r);
 ...
 */
const std::string& Move_SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector::getClassType(void)
{
    
    static std::string rev_type = "Move_SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector";
 ...
 */
const TypeSpec& Move_SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector::getClassTypeSpec(void)
{
 ...
 */
std::string Move_SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector::getMoveName( void ) const
{
    // create a constructor function name variable that is the same for all instance of this class
    std::string c_name = "SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector";
 ...
 */
const MemberRules& Move_SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector::getParameterRules(void) const
{
 ...
 */
const TypeSpec& Move_SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector::getTypeSpec( void ) const
{
 ...
 */
void Move_SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector::printValue(std::ostream &o) const
{
    
    o << "SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector(";
    if (tree != NULL)
    {
        o << tree->getName();
    }
 ...
 */
void Move_SubtreeScaleBetaRelativeBranchLengthSimplexAllTreeLengthVector::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
