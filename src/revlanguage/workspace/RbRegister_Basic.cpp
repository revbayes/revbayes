...
void RevLanguage::Workspace::initializeBasicGlobalWorkspace(void)
{
    ...
    try
    {
        ...
        addFunction( new Func_replicate<Integer, Natural>()          );
        addFunction( new Func_replicate<Real, Natural>()             );
        addFunction( new Func_replicate<Natural, Natural>()          );
        addFunction( new Func_replicate<RealPos, Natural>()          );
        addFunction( new Func_replicate<RlString, Natural>()         );
        addFunction( new Func_replicate<RlBoolean, Natural>()        );
        addFunction( new Func_replicate<SiteMixtureModel, Natural>() );
        addFunction( new Func_replicate<Integer, Real>()          );
        addFunction( new Func_replicate<Real, Real>()             );
        addFunction( new Func_replicate<Natural, Real>()          );
        addFunction( new Func_replicate<RealPos, Real>()          );
        addFunction( new Func_replicate<RlString, Real>()         );
        addFunction( new Func_replicate<RlBoolean, Real>()        );
        addFunction( new Func_replicate<SiteMixtureModel, Real>() );
        addFunction( new Func_replicate<Integer, RealPos>()          );
        addFunction( new Func_replicate<Real, RealPos>()             );
        addFunction( new Func_replicate<Natural, RealPos>()          );
        addFunction( new Func_replicate<RealPos, RealPos>()          );
        addFunction( new Func_replicate<RlString, RealPos>()         );
        addFunction( new Func_replicate<RlBoolean, RealPos>()        );
        addFunction( new Func_replicate<SiteMixtureModel, RealPos>() );
