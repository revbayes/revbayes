...
Transform_Scale_Prob::Transform_Scale_Prob() : TypedDistribution< Probability >(),
                                     base_distribution( NULL )
{
    markAsTransform();
}

Transform_Scale_Prob::~Transform_Scale_Prob()
{
}

Transform_Scale_Prob* Transform_Scale_Prob::clone( void ) const
{
    return new Transform_Scale_Prob(*this);
}

RevBayesCore::TransformedDistribution* Transform_Scale_Prob::createDistribution( void ) const
{
    // get the parameters
...
const std::string& Transform_Scale_Prob::getClassType(void)
{

    static std::string rev_type = "Transform_Scale_Prob";
 ...
 */
std::string Transform_Scale_Prob::getDistributionFunctionName( void ) const
{
...
const MemberRules& Transform_Scale_Prob::getParameterRules(void) const
{
...
const TypeSpec& Transform_Scale_Prob::getTypeSpec( void ) const
{
...
void Transform_Scale_Prob::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
