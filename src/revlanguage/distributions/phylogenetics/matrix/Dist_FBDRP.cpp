...
RevLanguage::MethodTable Dist_FBDRP::getDistributionMethods( void ) const
{
    ...
    methods.addFunction( new DistributionMemberFunction<Dist_FBDRP, ModelVector<RealPos> >( "getAugmentedFirstAges", variable, first_ages_arg_rules, true ) );
    ...
    methods.addFunction( new DistributionMemberFunction<Dist_FBDRP, ModelVector<RealPos> >( "getBirthAges", variable, birth_arg_rules, true ) );

    ArgumentRules* death_arg_rules = new ArgumentRules();
    methods.addFunction( new DistributionMemberFunction<Dist_FBDRP, ModelVector<RealPos> >( "getDeathAges", variable, death_arg_rules, true ) );
