#ifndef Dist_FBDPSpecimenSpecimen_H
#define Dist_FBDPSpecimenSpecimen_H
...
namespace RevLanguage {
     ...
     *c
     */
    class Dist_FBDPSpecimen : public BirthDeathProcess {

    public:
        Dist_FBDPSpecimen( void );

        // Basic utility functions
        Dist_FBDPSpecimen*                                      clone(void) const;                                                                      //!< Clone the object
