...
namespace RevLanguage {
    ...
    public:
        ...
        MethodTable                                             getDistributionMethods(void) const;                                                     //!< Member methods (getAugmentedAges)
    ...
    private:
        ...
        RevPtr<const RevVariable>                               extended;                                                                               //!< Whether tips are extinction times, or the extinction times are marginalized out
