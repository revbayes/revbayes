...
#include "OccurrenceBirthDeathProcessR.h"
 ...
 */
Dist_OccurrenceBirthDeathProcessR::Dist_OccurrenceBirthDeathProcessR() : BirthDeathProcess()
{
 ...
 */
Dist_OccurrenceBirthDeathProcessR* Dist_OccurrenceBirthDeathProcessR::clone( void ) const
{
    return new Dist_OccurrenceBirthDeathProcessR(*this);
}
 ...
 */
RevBayesCore::AbstractBirthDeathProcess* Dist_OccurrenceBirthDeathProcessR::createDistribution( void ) const
{
    ...
    // omega
    RevBayesCore::TypedDagNode<double>* o       = static_cast<const RealPos &>( psi->getRevObject() ).getDagNode();
    // sampling probability
    RevBayesCore::TypedDagNode<double>* r       = static_cast<const RealPos &>( rho->getRevObject() ).getDagNode();

    d = new RevBayesCore::OccurrenceBirthDeathProcessR(sa, l, m, p, o, r, cond, t, uo, init);
 ...
 */
const std::string& Dist_OccurrenceBirthDeathProcessR::getClassType( void )
{

    static std::string rev_type = "Dist_OccurrenceBirthDeathProcessR";
 ...
 */
const TypeSpec& Dist_OccurrenceBirthDeathProcessR::getClassTypeSpec( void )
{
 ...
 */
std::vector<std::string> Dist_OccurrenceBirthDeathProcessR::getDistributionFunctionAliases( void ) const
{
    // create alternative constructor function names variable that is the same for all instance of this class
    std::vector<std::string> a_names;
      a_names.push_back( "OBDPR" );
 ...
 */
std::string Dist_OccurrenceBirthDeathProcessR::getDistributionFunctionName( void ) const
{
    // create a distribution name variable that is the same for all instance of this class
    std::string d_name = "OccurrenceBirthDeathProcessR";
 ...
 */
const MemberRules& Dist_OccurrenceBirthDeathProcessR::getParameterRules(void) const
{
    ...
    if ( !rules_set )
    {
        ...
        dist_member_rules.push_back( new ArgumentRule( "omega",     paramTypes, "The serial sampling rate(s).", ArgumentRule::BY_CONSTANT_REFERENCE, ArgumentRule::ANY, new RealPos(0.0) ) );
 ...
 */
const TypeSpec& Dist_OccurrenceBirthDeathProcessR::getTypeSpec( void ) const
{
 ...
 */
void Dist_OccurrenceBirthDeathProcessR::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
    if ( name == "lambda" )
    {
        lambda = var;
