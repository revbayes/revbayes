...
const MemberRules& Dist_PhyloCharacterEvent::getParameterRules(void) const
{
    ...
    if ( !rules_set )
    {
        ...
        member_rules.push_back( new ArgumentRule( "baseDistributions"   , WorkspaceVector<TypedDistribution<RealPos> >::getClassTypeSpec()  , "The prior distribution for the speciation rates."        , ArgumentRule::BY_CONSTANT_REFERENCE   , ArgumentRule::ANY ) );
