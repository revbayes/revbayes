...
Dist_PhyloMultiSampleOrnsteinUhlenbeckREML::Dist_PhyloMultiSampleOrnsteinUhlenbeckREML() : TypedDistribution< ContinuousCharacterData >()
{
    
}


Dist_PhyloMultiSampleOrnsteinUhlenbeckREML::~Dist_PhyloMultiSampleOrnsteinUhlenbeckREML()
{
...
Dist_PhyloMultiSampleOrnsteinUhlenbeckREML* Dist_PhyloMultiSampleOrnsteinUhlenbeckREML::clone( void ) const
{
    
    return new Dist_PhyloMultiSampleOrnsteinUhlenbeckREML(*this);
}


RevBayesCore::TypedDistribution< RevBayesCore::ContinuousCharacterData >* Dist_PhyloMultiSampleOrnsteinUhlenbeckREML::createDistribution( void ) const
{
    ...
    RevBayesCore::PhyloMultiSampleOrnsteinUhlenbeckProcessREML *dist = new RevBayesCore::PhyloMultiSampleOrnsteinUhlenbeckProcessREML(tau, var, t, n);
...
const std::string& Dist_PhyloMultiSampleOrnsteinUhlenbeckREML::getClassType(void)
{
    
    static std::string rev_type = "Dist_PhyloMultiSampleOrnsteinUhlenbeckREML";
    
    return rev_type;
}

/* Get class type spec describing type of object */
const TypeSpec& Dist_PhyloMultiSampleOrnsteinUhlenbeckREML::getClassTypeSpec(void)
{
 ...
 */
std::string Dist_PhyloMultiSampleOrnsteinUhlenbeckREML::getDistributionFunctionName( void ) const
{
    // create a distribution name variable that is the same for all instance of this class
    std::string d_name = "PhyloMultiSampleOrnsteinUhlenbeckREML";
...
const MemberRules& Dist_PhyloMultiSampleOrnsteinUhlenbeckREML::getParameterRules(void) const
{
...
const TypeSpec& Dist_PhyloMultiSampleOrnsteinUhlenbeckREML::getTypeSpec( void ) const
{
...
void Dist_PhyloMultiSampleOrnsteinUhlenbeckREML::printValue(std::ostream& o) const
{
    
    o << "PhyloMultiSampleOrnsteinUhlenbeckREML(tree=";
    if ( tree != NULL )
    {
        o << tree->getName();
    }
...
void Dist_PhyloMultiSampleOrnsteinUhlenbeckREML::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
