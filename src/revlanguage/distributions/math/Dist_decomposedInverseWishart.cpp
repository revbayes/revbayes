...
const MemberRules& Dist_decomposedInverseWishart::getParameterRules(void) const
{
    ...
    if ( !rules_set )
    {
        ...
        dist_member_rules.push_back( new ArgumentRule( "df"      , Natural::getClassTypeSpec(), "", ArgumentRule::BY_CONSTANT_REFERENCE, ArgumentRule::ANY, new Natural(0LL) ) );
        ...
        dist_member_rules.push_back( new ArgumentRule( "dim"     , Natural::getClassTypeSpec(), "", ArgumentRule::BY_CONSTANT_REFERENCE, ArgumentRule::ANY, new Natural(0LL) ) );
        rules_set = true;
    }
