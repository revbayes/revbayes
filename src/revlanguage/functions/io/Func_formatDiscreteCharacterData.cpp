...
const ArgumentRules& Func_formatDiscreteCharacterData::getArgumentRules( void ) const
{
    ...
    if (!rulesSet)
    {
        ...
        argumentRules.push_back( new ArgumentRule( "numStates", Natural::getClassTypeSpec(), "The number of states (format==\"DEC\" or \"GeoSSE\" only).", ArgumentRule::BY_VALUE, ArgumentRule::ANY, new Natural(0LL)) );
