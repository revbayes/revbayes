 ...
 */
Func_convertVCFtoSFS* Func_convertVCFtoSFS::clone( void ) const
{
    
    return new Func_convertVCFtoSFS( *this );
}


/** Execute function */
RevPtr<RevVariable> Func_convertVCFtoSFS::execute( void )
{
    size_t arg_index = 0;
    ...
    RevBayesCore::RbVector<long> sfs = vcf_reader.convertToSFS( taxa );
...
/** Get argument rules */
const ArgumentRules& Func_convertVCFtoSFS::getArgumentRules( void ) const
{
...
const std::string& Func_convertVCFtoSFS::getClassType(void)
{
    
    static std::string rev_type = "Func_convertVCFtoSFS";
...
const TypeSpec& Func_convertVCFtoSFS::getClassTypeSpec(void)
{
 ...
 */
std::string Func_convertVCFtoSFS::getFunctionName( void ) const
{
    // create a name variable that is the same for all instance of this class
    std::string f_name = "convertVCFtoSFS";
...
/** Get type spec */
const TypeSpec& Func_convertVCFtoSFS::getTypeSpec( void ) const
{
...
/** Get return type */
const TypeSpec& Func_convertVCFtoSFS::getReturnType( void ) const
{
