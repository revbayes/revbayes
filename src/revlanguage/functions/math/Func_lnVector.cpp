...
/** default constructor */
Func_lnVector::Func_lnVector( void ) : TypedFunction< ModelVector<Real> >( )
{
 ...
 */
Func_lnVector* Func_lnVector::clone( void ) const
{

    return new Func_lnVector( *this );
}
...
/* Get argument rules */
const ArgumentRules& Func_lnVector::getArgumentRules( void ) const
{
...
const std::string& Func_lnVector::getClassType(void)
{

    static std::string rev_type = "Func_lnVector";
 ...
 */
std::string Func_lnVector::getFunctionName( void ) const
{
...
const TypeSpec& Func_lnVector::getTypeSpec( void ) const
{
