#ifndef Func_sumMatrix_H
#define Func_sumMatrix_H
...
namespace RevLanguage {
    ...
    public:
        ...
        Func_sumMatrix*                                 clone(void) const;                                          //!< Clone the object
...
/** default constructor */
Func_sumMatrix::Func_sumMatrix( void ) : TypedFunction<Real>( )
{
 ...
 */
Func_sumMatrix* Func_sumMatrix::clone( void ) const
{
    
    return new Func_sumMatrix( *this );
}
...
/* Get argument rules */
const ArgumentRules& Func_sumMatrix::getArgumentRules( void ) const
{
...
const std::string& Func_sumMatrix::getClassType(void)
{
    
    static std::string rev_type = "Func_sumMatrix";
...
const TypeSpec& Func_sumMatrix::getClassTypeSpec(void)
{
 ...
 */
std::string Func_sumMatrix::getFunctionName( void ) const
{
...
const TypeSpec& Func_sumMatrix::getTypeSpec( void ) const
{
