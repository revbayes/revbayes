#ifndef Func_logVector_H
#define Func_logVector_H
...
namespace RevLanguage {
     ...
     *
     */
    class Func_logVector : public TypedFunction< ModelVector<Real> > {

    public:
        Func_logVector( void );

        // Basic utility functions
        Func_logVector*                                                      clone(void) const;                                          //!< Clone the object
