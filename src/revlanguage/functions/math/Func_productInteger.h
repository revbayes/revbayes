#ifndef Func_productInteger_H
#define Func_productInteger_H
...
namespace RevLanguage {
     ...
     *
     */
    class Func_productInteger :  public TypedFunction<Integer> {
        
    public:
        Func_productInteger( void );
        
        // Basic utility functions
        Func_productInteger*                                      clone(void) const;                                          //!< Clone the object
