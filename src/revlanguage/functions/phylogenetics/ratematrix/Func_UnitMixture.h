#ifndef Func_UnitMixture_H
#define Func_UnitMixture_H
...
class TypeSpec;
     ...
     *
     */
    class Func_UnitMixture: public TypedFunction<SubstitutionMixtureModel> {

    public:
        Func_UnitMixture( void );

        // Basic utility functions
        Func_UnitMixture*                                                clone(void) const;                                          //!< Clone the object
