 ...
 *
 * @brief Declaration and implementation of Func_revPoMoM2N
 *
...
#ifndef Func_revPoMoM2N_H
#define Func_revPoMoM2N_H
...
namespace RevLanguage {
    ...
    class Func_revPoMoM2N : public TypedFunction<RateMatrix> {

    public:
        Func_revPoMoM2N( void );

        // Basic utility functions
        Func_revPoMoM2N*                                                clone(void) const;                                          //!< Clone the object
