#ifndef Func_ScaleVectorSiteMixtureModel_H
#define Func_ScaleVectorSiteMixtureModel_H
...
class TypeSpec;
     ...
     *
     */
    class Func_ScaleVectorSiteMixtureModel: public TypedFunction<ModelVector<SiteMixtureModel>> {

    public:
        Func_ScaleVectorSiteMixtureModel( void );

        // Basic utility functions
        Func_ScaleVectorSiteMixtureModel*                                   clone(void) const;                                          //!< Clone the object
