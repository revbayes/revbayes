#ifndef Func_revPoMo2Nrecurrent_H
#define Func_revPoMo2Nrecurrent_H
...
namespace RevLanguage {
     ...
     *
     */
    class Func_revPoMo2Nrecurrent : public TypedFunction<RateMatrix> {
        
    public:
        Func_revPoMo2Nrecurrent( void );
        
        // Basic utility functions
        Func_revPoMo2Nrecurrent*                                                        clone(void) const;                                          //!< Clone the object
