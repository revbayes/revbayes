...
RevBayesCore::ConcreteMixtureModel* GammaRateModelFunc(const RevBayesCore::RateGenerator& gen, double a, int nCats, RevBayesCore::Boolean median)
{
    using namespace RevBayesCore;
    ...
    return scaled_mixture( UnitMixtureModel(matrix), fraction, rates );
}
...
RevBayesCore::TypedFunction< RevBayesCore::MixtureModel >* Func_GammaRateModel::createFunction( void ) const
{
    ...
    return RevBayesCore::generic_function_ptr< RevBayesCore::MixtureModel >( GammaRateModelFunc, matrix, a, nCats, median);
}
