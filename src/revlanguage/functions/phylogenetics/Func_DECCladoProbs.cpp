...
const ArgumentRules& Func_DECCladoProbs::getArgumentRules( void ) const
{
    ...
    if ( !rules_set )
    {
        ...
        argumentRules.push_back( new ArgumentRule( "maxRangeSize", Natural::getClassTypeSpec(), "The maximum range size.", ArgumentRule::BY_VALUE, ArgumentRule::ANY, new Natural(0LL) ) );
