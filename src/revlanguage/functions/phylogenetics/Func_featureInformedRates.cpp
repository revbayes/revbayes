...
RevBayesCore::TypedFunction< RevBayesCore::RbVector<RevBayesCore::RbVector<double> > >* Func_featureInformedRates::createFunction( void ) const
{
    ...
    // supplied arguments
    RevBayesCore::TypedDagNode<RevBayesCore::RbVector<RevBayesCore::RbVector<RevBayesCore::RbVector<std::int64_t> > > >* cf = static_cast<const ModelVector<ModelVector<ModelVector<Natural> > >&>( this->args[0].getVariable()->getRevObject() ).getDagNode();
