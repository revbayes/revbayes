...
/** Default constructor */
Func_getSESpeciesMean::Func_getSESpeciesMean( void ) : TypedFunction<ModelVector<Real> >()
{
 ...
 */
Func_getSESpeciesMean* Func_getSESpeciesMean::clone( void ) const
{

    return new Func_getSESpeciesMean( *this );
}


RevBayesCore::TypedFunction<RevBayesCore::RbVector<double> >* Func_getSESpeciesMean::createFunction( void ) const
{
    ...
    RevBayesCore::GetTipErrorOrVarianceFunction* f = new RevBayesCore::GetTipErrorOrVarianceFunction( data, v_site, n_site, mtr, true );
...
/** Get argument rules */
const ArgumentRules& Func_getSESpeciesMean::getArgumentRules( void ) const
{
...
const std::string& Func_getSESpeciesMean::getClassType(void)
{

    static std::string rev_type = "Func_getSESpeciesMean";

    return rev_type;
}

/** Get class type spec describing type of object */
const TypeSpec& Func_getSESpeciesMean::getClassTypeSpec(void)
{
 ...
 */
std::string Func_getSESpeciesMean::getFunctionName( void ) const
{
    // create a name variable that is the same for all instance of this class
    std::string f_name = "fnGetSEMean";

    return f_name;
}

std::vector<std::string> Func_getSESpeciesMean::getFunctionNameAliases( void ) const
{
    // create alternative constructor function names variable that is the same for all instance of this class
    std::vector<std::string> a_names;
    a_names.push_back( "fnGetSEM" );

    return a_names;
}

/** Get type spec */
const TypeSpec& Func_getSESpeciesMean::getTypeSpec( void ) const
{
