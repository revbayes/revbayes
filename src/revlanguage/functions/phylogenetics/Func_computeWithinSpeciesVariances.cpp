...
/** Default constructor */
Func_computeWithinSpeciesVariances::Func_computeWithinSpeciesVariances( void ) : TypedFunction<ModelVector<Real> >()
{
 ...
 */
Func_computeWithinSpeciesVariances* Func_computeWithinSpeciesVariances::clone( void ) const
{

    return new Func_computeWithinSpeciesVariances( *this );
}


RevBayesCore::TypedFunction<RevBayesCore::RbVector<double> >* Func_computeWithinSpeciesVariances::createFunction( void ) const
{
...
/** Get argument rules */
const ArgumentRules& Func_computeWithinSpeciesVariances::getArgumentRules( void ) const
{
...
const std::string& Func_computeWithinSpeciesVariances::getClassType(void)
{

    static std::string rev_type = "Func_computeWithinSpeciesVariances";

    return rev_type;
}

/** Get class type spec describing type of object */
const TypeSpec& Func_computeWithinSpeciesVariances::getClassTypeSpec(void)
{
 ...
 */
std::string Func_computeWithinSpeciesVariances::getFunctionName( void ) const
{
    // create a name variable that is the same for all instance of this class
    std::string f_name = "fnComputeWithinSpeciesVariances";

    return f_name;
}

std::vector<std::string> Func_computeWithinSpeciesVariances::getFunctionNameAliases( void ) const
{
    // create alternative constructor function names variable that is the same for all instance of this class
    std::vector<std::string> a_names;
    a_names.push_back( "fnSpVar" );

    return a_names;
}

/** Get type spec */
const TypeSpec& Func_computeWithinSpeciesVariances::getTypeSpec( void ) const
{
