...
class TypeSpec;
     ...
     *
     */
    class Func_PseudoDataLogNormal: public TypedFunction<PseudoData<Real>> {

    public:
        Func_PseudoDataLogNormal( void );

        // Basic utility functions
        Func_PseudoDataLogNormal*                                           clone(void) const;                                          //!< Clone the object
