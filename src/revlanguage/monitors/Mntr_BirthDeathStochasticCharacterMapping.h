//
//  Mntr_BirthDeathStochasticCharacterMapping.h
...
#ifndef __RevBayes_development_branch__Mntr_BirthDeathStochasticCharacterMapping__
#define __RevBayes_development_branch__Mntr_BirthDeathStochasticCharacterMapping__
...
namespace RevLanguage {
    ...
    class Mntr_BirthDeathStochasticCharacterMapping : public Monitor {
        
    public:
        
        Mntr_BirthDeathStochasticCharacterMapping(void);                                                                                            //!< Default constructor
        
        // Basic utility functions
        virtual Mntr_BirthDeathStochasticCharacterMapping*  clone(void) const;                                                                      //!< Clone object
    ...
    protected:
        ...
        RevPtr<const RevVariable>                       complete_tree;
