...
namespace RevBayesCore
{
    ...
    public:
        ...
        // ModelVector< > somehow requires equality and ordering operations.
        bool operator==(const PseudoObservation&) const { return true; }
        std::strong_ordering operator<=>(const PseudoObservation&) const { return std::strong_ordering::equal; }
    };
