...
namespace RevBayesCore {
    ...
    class RateMatrix_PoMo4N : public TimeReversibleRateMatrix {
        
    public:
        RateMatrix_PoMo4N(  long num_states , long in_n );                                                                                            //!< Construct rate matrix with n states
        RateMatrix_PoMo4N(const RateMatrix_PoMo4N& m);                                                                  //!< Copy constructor
        ...
        virtual RateMatrix_PoMo4N&                              assign(const Assignable &m);                                                                                       //!< Assign operation that can be called on a base class instance.
