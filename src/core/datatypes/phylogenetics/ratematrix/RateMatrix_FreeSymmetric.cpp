...
void RateMatrix_FreeSymmetric::expandUniformization(int truncation, double tolerance) const
{
...
void RateMatrix_FreeSymmetric::tiProbsScalingAndSquaring(double t, TransitionProbabilityMatrix& P) const
{
...
void RateMatrix_FreeSymmetric::tiProbsUniformization(double t, TransitionProbabilityMatrix& P) const
{
...
void RateMatrix_FreeSymmetric::updateUniformization(void)
{
