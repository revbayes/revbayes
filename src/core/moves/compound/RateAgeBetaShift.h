...
namespace RevBayesCore {
    ...
    public:
        RateAgeBetaShift( StochasticNode<Tree> *tr, std::vector<StochasticNode<double> *> n, StochasticNode<RbVector<double> > *sn, double delta, double weight, size_t del, bool t);                                                         //!<  constructor
