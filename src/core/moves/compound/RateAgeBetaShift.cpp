...
RateAgeBetaShift::RateAgeBetaShift(StochasticNode<Tree> *tr, std::vector<StochasticNode<double> *> v, StochasticNode<RbVector<double> > *sv, double d, bool t, double w, size_t del, double targetAcceptanceRate) : AbstractMove( w, t),
    tree( tr ),
    rates_vec( v ),
    rates( sv ),
    delta( d ),
