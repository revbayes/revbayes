 ...
 */
MirrorProposal::MirrorProposal( StochasticNode<double> *n, double l, double m0, double n0, double c0, double m, bool a, double p) : Proposal(p),
    variable( n ),
    storedValue( 0.0 ),
    lambda( l ),
 ...
 *
 */
void MirrorProposal::cleanProposal( void )
{
    ; // do nothing
}
 ...
 */
MirrorProposal* MirrorProposal::clone( void ) const
{

    return new MirrorProposal( *this );
}
 ...
 */
const std::string& MirrorProposal::getProposalName( void ) const
{
    static std::string name = "Mirror";

    return name;
}


double MirrorProposal::getProposalTuningParameter( void ) const
{
    return lambda;
}
 ...
 *
 */
void MirrorProposal::prepareProposal( void )
{
 ...
 */
void MirrorProposal::printParameterSummary(std::ostream &o, bool name_only) const
{
 ...
 */
void MirrorProposal::undoProposal( void )
{
...
void MirrorProposal::setProposalTuningParameter(double tp)
{
    lambda = tp;
}
 ...
 */
void MirrorProposal::tune( double rate )
{
