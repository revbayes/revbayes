 ...
 *
 */
void FossilSiteTimeSlideUniformProposal::cleanProposal( void )
{
    // do nothing
}
 ...
 */
FossilSiteTimeSlideUniformProposal* FossilSiteTimeSlideUniformProposal::clone( void ) const
{
    
    return new FossilSiteTimeSlideUniformProposal( *this );
}
 ...
 */
const std::string& FossilSiteTimeSlideUniformProposal::getProposalName( void ) const
{
    static std::string name = "FossilSiteTimeSlideUniform";
    
    return name;
}


double FossilSiteTimeSlideUniformProposal::getProposalTuningParameter( void ) const
{
 ...
 */
double FossilSiteTimeSlideUniformProposal::doProposal( void )
{
 ...
 *
 */
void FossilSiteTimeSlideUniformProposal::prepareProposal( void )
{
 ...
 */
void FossilSiteTimeSlideUniformProposal::printParameterSummary(std::ostream &o, bool name_only) const
{
 ...
 */
void FossilSiteTimeSlideUniformProposal::undoProposal( void )
{
 ...
 */
void FossilSiteTimeSlideUniformProposal::swapNodeInternal(DagNode *oldN, DagNode *newN)
{
...
void FossilSiteTimeSlideUniformProposal::setProposalTuningParameter(double tp)
{
    lambda = tp;
}
 ...
 */
void FossilSiteTimeSlideUniformProposal::tune( double rate )
{
