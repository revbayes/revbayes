#ifndef FossilTipTimeSlideUniformProposal_H
#define FossilTipTimeSlideUniformProposal_H
...
namespace RevBayesCore {
     ...
     *
     */
    class FossilTipTimeSlideUniformProposal : public Proposal {
        
    public:
        FossilTipTimeSlideUniformProposal( StochasticNode<Tree> *n,
        ...
        FossilTipTimeSlideUniformProposal*      clone(void) const;                                              //!< Clone object
