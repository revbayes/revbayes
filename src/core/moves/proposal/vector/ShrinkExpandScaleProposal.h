...
template <class variableType> class StochasticNode;
     ...
     *
     */
    class ShrinkExpandScaleProposal : public Proposal {
        
    public:
        ShrinkExpandScaleProposal(std::vector<StochasticNode<double> *> n, StochasticNode<double> *s, double l);                             //!< Constructor
        
        void                                        cleanProposal(void);                                                                //!< Clean up proposal
        ShrinkExpandScaleProposal*                  clone(void) const;                                                                  //!< Clone object
