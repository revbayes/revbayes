#ifndef BranchRateNodeValueScaleProposal_H
#define BranchRateNodeValueScaleProposal_H
...
namespace RevBayesCore {
     ...
     *
     */
    class BranchRateNodeValueScaleProposal : public Proposal {
        
    public:
        BranchRateNodeValueScaleProposal( StochasticNode< RbVector<double> > *n, TypedDagNode< Tree > *t, double l, double p=0.44);                                                                    //!<  constructor
        
        // Basic utility functions
        void                                cleanProposal(void);                                                                //!< Clean up proposal
        BranchRateNodeValueScaleProposal*   clone(void) const;                                                                  //!< Clone object
