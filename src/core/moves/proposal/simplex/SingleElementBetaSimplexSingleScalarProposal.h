#ifndef SingleElementBetaSimplexSingleScalarProposal_H
#define SingleElementBetaSimplexSingleScalarProposal_H
...
namespace RevBayesCore {
     ...
     *
     */
    class SingleElementBetaSimplexSingleScalarProposal : public Proposal {
        
    public:
        SingleElementBetaSimplexSingleScalarProposal( StochasticNode<Simplex> *n, double a, double p=0.44);                                                     //!<  constructor
        ...
        SingleElementBetaSimplexSingleScalarProposal*   clone(void) const;                                          //!< Clone object
