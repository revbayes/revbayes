 ...
 */
SingleElementBetaSimplexSingleScalarProposal::SingleElementBetaSimplexSingleScalarProposal( StochasticNode<Simplex> *n, double a, double p) : Proposal(p),
simplex ( n ),
alpha( a )
{
...
void SingleElementBetaSimplexSingleScalarProposal::addIndex( size_t v )
{
...
void SingleElementBetaSimplexSingleScalarProposal::addScalar( StochasticNode<double> *v )
{
 ...
 *
 */
void SingleElementBetaSimplexSingleScalarProposal::cleanProposal( void )
{
 ...
 */
SingleElementBetaSimplexSingleScalarProposal* SingleElementBetaSimplexSingleScalarProposal::clone( void ) const
{
    
    return new SingleElementBetaSimplexSingleScalarProposal( *this );
}
 ...
 */
const std::string& SingleElementBetaSimplexSingleScalarProposal::getProposalName( void ) const
{
    static std::string name = "SingleElementBetaSimplexSingleScalar";
    
    return name;
}


double SingleElementBetaSimplexSingleScalarProposal::getProposalTuningParameter( void ) const
{
    return alpha;
}
 ...
 */
double SingleElementBetaSimplexSingleScalarProposal::doProposal( void )
{
    // reset flag
    failed = false;
    ...
    if (scalar_added == true)
    {
        ...
        double scalar_new = scalar_current / scaling_factor_unaffected;
 ...
 *
 */
void SingleElementBetaSimplexSingleScalarProposal::prepareProposal( void )
{
 ...
 */
void SingleElementBetaSimplexSingleScalarProposal::printParameterSummary(std::ostream &o, bool name_only) const
{
 ...
 */
void SingleElementBetaSimplexSingleScalarProposal::undoProposal( void )
{
 ...
 */
void SingleElementBetaSimplexSingleScalarProposal::swapNodeInternal(DagNode *oldN, DagNode *newN)
{
...
void SingleElementBetaSimplexSingleScalarProposal::setProposalTuningParameter(double tp)
{
    alpha = tp;
}
 ...
 */
void SingleElementBetaSimplexSingleScalarProposal::tune( double rate )
{
