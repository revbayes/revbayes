 ...
 */
const std::string& SortedBetaSimplexProposal::getProposalName( void ) const
{
...
double SortedBetaSimplexProposal::getProposalTuningParameter( void ) const
{
    return alpha;
}
 ...
 */
double SortedBetaSimplexProposal::propose( Simplex &value )
{
 ...
 *
 */
void SortedBetaSimplexProposal::prepareProposal( void )
{
 ...
 */
void SortedBetaSimplexProposal::printParameterSummary(std::ostream &o, bool name_only) const
{
 ...
 */
void SortedBetaSimplexProposal::undoProposal( void )
{
 ...
 */
void SortedBetaSimplexProposal::swapNodeInternal(DagNode *oldN, DagNode *newN)
{
...
void SortedBetaSimplexProposal::setProposalTuningParameter(double tp)
{
    alpha = tp;
}
 ...
 */
void SortedBetaSimplexProposal::tune( double rate )
{
