...
namespace RevBayesCore {
    ...
    public:
        ...
        SliceSamplingMove(StochasticNode<double> *p, boost::optional<double>, boost::optional<double>, double window_, BoundarySearchMethod bsm,double weight_, size_t d=0, bool autoTune = false);        //!< Constructor
