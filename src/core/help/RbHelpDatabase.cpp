...
RevBayesCore::RbHelpDatabase::RbHelpDatabase()
{
	...
	help_strings[string("Bool")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("BootstrapAnalysis")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("BranchLengthTree")][string("see_also")] = string(R"(TimeTree
BranchLengthTree)");
	...
	help_strings[string("HillClimber")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("HillClimber")][string("see_also")] = string(R"(SimulatedAnnealing)");
	...
	help_strings[string("Probability")][string("authors")] = string(R"(Sebastian Hoehna)");
...
`Natural` which are the counting numbers (e.g. 1,2,3,...).)");
	...
	help_strings[string("Real")][string("see_also")] = string(R"(`RealPos`, `Integer`, `Natural`, `Probability`)");
...
M := fnJC(4) |> fnGammaASRV(alpha=1) |> fnInvASRV(pInv=0.1))");
	...
	help_strings[string("TimeTree")][string("see_also")] = string(R"(TimeTree
BranchLengthTree)");
	...
	help_strings[string("Tree")][string("see_also")] = string(R"(TimeTree
BranchLengthTree)");
	...
	help_strings[string("abs")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("abs")][string("see_also")] = string(R"(ceil
floor
round)");
	...
	help_strings[string("append")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("append")][string("see_also")] = string(R"(rep)");
	...
	help_strings[string("ceil")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("ceil")][string("see_also")] = string(R"(abs
floor
round)");
	...
	help_strings[string("choose")][string("authors")] = string(R"(Michael Landis)");
	...
	help_strings[string("clade")][string("authors")] = string(R"(Will Pett
Sebastian Hoehna
Michael Landis)");
	...
	help_strings[string("clade")][string("see_also")] = string(R"(dnConstrainedTopology
tmrca
mrcaIndex)");
	help_strings[string("clade")][string("title")] = string(R"(Clade)");
	help_strings[string("clear")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("clear")][string("see_also")] = string(R"(exists)");
	help_strings[string("clear")][string("title")] = string(R"(Clear the current workspace)");
	help_strings[string("combineCharacter")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("concatenate")][string("authors")] = string(R"(Michael Landis)");
	...
	help_strings[string("consensusTree")][string("authors")] = string(R"(Seraina Klopfstein
Will Freyman
Will Pett
Sebastian Hoehna)");
	...
	help_strings[string("consensusTree")][string("see_also")] = string(R"(mapTree
mccTree
treeTrace
readTreeTrace)");
	...
	help_strings[string("diagonalMatrix")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnBernoulli")][string("authors")] = string(R"(John Huelsenbeck)");
	...
	help_strings[string("dnBernoulli")][string("see_also")] = string(R"(dnBinomial)");
	help_strings[string("dnBernoulli")][string("title")] = string(R"(Bernoulli Distribution)");
	help_strings[string("dnBeta")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnBeta")][string("see_also")] = string(R"(dnDirichlet)");
	help_strings[string("dnBeta")][string("title")] = string(R"(Beta Distribution)");
	help_strings[string("dnBimodalLognormal")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnBimodalLognormal")][string("see_also")] = string(R"(dnBimodalNormal
dnLognormal)");
	help_strings[string("dnBimodalLognormal")][string("title")] = string(R"(Bimodal Lognormal Distribution)");
	help_strings[string("dnBimodalNormal")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnBimodalNormal")][string("see_also")] = string(R"(dnBimodalLognormal
dnNormal)");
	help_strings[string("dnBimodalNormal")][string("title")] = string(R"(Bernoulli Distribution)");
	help_strings[string("dnBinomial")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnBinomial")][string("see_also")] = string(R"(dnBernoulli)");
	...
	help_strings[string("dnBivariatePoisson")][string("authors")] = string(R"(Alexander Zarebski
Sebastian Hoehna)");
	...
	help_strings[string("dnBivariatePoisson")][string("references")] = string(R"(- citation: Karlis D, Ntzoufras J (2003). Bayesian and Non-Bayesian Analysis of Soccer
    Data using Bivariate Poisson Regression Models.
  doi: null
  url: null)");
	help_strings[string("dnBivariatePoisson")][string("see_also")] = string(R"(dnPoisson)");
	...
	help_strings[string("dnCategorical")][string("authors")] = string(R"(Fredrik Ronquist)");
...
A typical scenario where a categorical variable is used is in the definition of a variable drawn from a mixture. A vector of mixture components is set up first, and then a stochastic variable drawn from a categorical distribution is used as an index in a deterministic assignment that points to a component in the mixture. See example below.)");
	...
	help_strings[string("dnCategorical")][string("see_also")] = string(R"(dnBinomial)");
	help_strings[string("dnCategorical")][string("title")] = string(R"(The Categorical Distribution)");
	help_strings[string("dnCauchy")][string("authors")] = string(R"(Andrew Magee)");
...
f(x) = 1/(pi * scale) * 1/(1 + x-(location/scale)^2))");
	...
	help_strings[string("dnChisq")][string("authors")] = string(R"(Sebastian Hoehna)");
...
# continue as usual to either clamp the genealogy or infer the genealogy based on sequence data)");
	...
	help_strings[string("dnDirichlet")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnDirichlet")][string("see_also")] = string(R"(simplex)");
	...
	help_strings[string("dnDuplicationLoss")][string("authors")] = string(R"(Sebastian Hoehna, Bastien Boussau, Dominik ...)");
...
The effective population size is constant across the species tree.)");
	...
	help_strings[string("dnDuplicationLoss")][string("references")] = string(R"(- citation: Bayes Estimation of Species Divergence Times and Ancestral Population
  ...
  url: http://www.genetics.org/content/164/4/1645.short)");
	help_strings[string("dnDuplicationLoss")][string("see_also")] = string(R"(dnMultiSpeciesCoalescentUniformPrior
dnMultiSpeciesCoalescentInverseGamma)");
	...
	help_strings[string("dnEmpiricalTree")][string("authors")] = string(R"(Will Freyman
Sebastian Hoehna
Will Pett)");
	...
	help_strings[string("dnEmpiricalTree")][string("see_also")] = string(R"(mvEmpiricalTree
treeTrace
readTreeTrace)");
	...
	help_strings[string("dnExponential")][string("authors")] = string(R"(Michael Landis)");
...
where lambda is the rate parameter.)");
	...
	help_strings[string("dnFossilizedBirthDeathRange")][string("authors")] = string(R"(Walker Pett)");
...
moves.append( mvMatrixElementSlide(bd, weight=taxa.size()) ))");
	...
	help_strings[string("dnFossilizedBirthDeathRange")][string("references")] = string(R"(        - citation: The fossilized birth-death model for the analysis of stratigraphic range data under different speciation modes. Stadler, Tanja et al. Journal of theoretical biology, 447:41-55.
	...
	help_strings[string("dnFossilizedBirthDeathRange")][string("see_also")] = string(R"(dnBirthDeathSamplingTreatment
mvResampleFBD)");
	help_strings[string("dnFossilizedBirthDeathSpeciation")][string("authors")] = string(R"(Walker Pett)");
...
moves.append( mvTipTimeSlideUniform(bd, weight = taxa.size()) ))");
	...
	help_strings[string("dnFossilizedBirthDeathSpeciation")][string("references")] = string(R"(        - citation: The fossilized birth-death model for the analysis of stratigraphic range data under different speciation modes. Stadler, Tanja et al. Journal of theoretical biology, 447:41-55.
          doi: doi.org/10.1016/j.jtbi.2018.03.005
          url: https://www.sciencedirect.com/science/article/pii/S002251931830119X)");
	help_strings[string("dnFossilizedBirthDeathSpeciation")][string("see_also")] = string(R"(dnFossilizedBirthDeathRange
dnBirthDeathSamplingTreatment
mvResampleFBD)");
	help_strings[string("dnGamma")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnGamma")][string("see_also")] = string(R"(dnExponential)");
	help_strings[string("dnGamma")][string("title")] = string(R"(Gamma Distribution)");
	help_strings[string("dnGeometric")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnGeometric")][string("see_also")] = string(R"(dnPoisson
mvRandomIntegerWalk)");
	...
	help_strings[string("dnHalfCauchy")][string("authors")] = string(R"(Andrew Magee)");
...
f(x) = 2/(pi * sigma) * 1/(1 + x-(location/scale)^2))");
	...
	help_strings[string("dnHalfNormal")][string("authors")] = string(R"(Andrew Magee)");
...
where offset is the offset of the distribution and sigma the standard deviation.)");
	...
	help_strings[string("dnHalfNormal")][string("see_also")] = string(R"(dnNormal
dnLognormal)");
	...
	help_strings[string("dnInverseGamma")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnInverseGamma")][string("see_also")] = string(R"(dnExponential)");
	...
	help_strings[string("dnLKJ")][string("authors")] = string(R"(Michael R. May)");
	...
	help_strings[string("dnLKJ")][string("references")] = string(R"(- citation: Lewandowski D, D Kurowicka, H Joe (2009). Generating random correlation
    matrices based on vines and extended onion method. Journal of Multivariate Analysis,
    100(9):1989-2001.
  doi: null
  url: null)");
	help_strings[string("dnLKJ")][string("see_also")] = string(R"(dnLKJPartial)");
	help_strings[string("dnLKJ")][string("title")] = string(R"(LKJ Distribution)");
	help_strings[string("dnLKJPartial")][string("authors")] = string(R"(Michael R. May)");
...
f(x) = det(x)^(eta - 1))");
	...
	help_strings[string("dnLKJPartial")][string("references")] = string(R"(- citation: Lewandowski D, D Kurowicka, H Joe (2009). Generating random correlation
    matrices based on vines and extended onion method. Journal of Multivariate Analysis,
    100(9):1989-2001.
  doi: null
  url: null)");
	help_strings[string("dnLKJPartial")][string("see_also")] = string(R"(dnLKJ)");
	help_strings[string("dnLKJPartial")][string("title")] = string(R"(LKJ Distribution (for partial correlation matrices))");
	help_strings[string("dnLaplace")][string("authors")] = string(R"(Will Freyman)");
...
where mu is the mean of the distribution and b the scale.)");
	...
	help_strings[string("dnLaplace")][string("see_also")] = string(R"(dnExponential
dnNormal)");
...
x ~ dnLog(dnMultivariateNormal(mu,Sigma)))");
	...
	help_strings[string("dnLognormal")][string("authors")] = string(R"(Michael Landis)");
...
where mu is the mean of the distribution and sigma the standard deviation.)");
	...
	help_strings[string("dnLoguniform")][string("authors")] = string(R"(Nicolas Lartillot)");
...
The log-uniform distribution is improper when defined over the entire positive real line. To always make it proper, in RevBayes, a min and a max should always be specified.)");
	...
	help_strings[string("dnLoguniform")][string("see_also")] = string(R"(dnUniform)");
	...
	help_strings[string("dnMultiSpeciesCoalescent")][string("authors")] = string(R"(Sebastian Hoehna, Bastien Boussau)");
...
The effective population size is constant across the species tree.)");
	...
	help_strings[string("dnMultiSpeciesCoalescent")][string("references")] = string(R"(- citation: Bayes Estimation of Species Divergence Times and Ancestral Population
    Sizes Using DNA Sequences From Multiple Loci. Bruce Rannala and Ziheng Yang. GENETICS
    August 1, 2003 vol. 164 no. 4 1645-1656.
  doi: null
  url: http://www.genetics.org/content/164/4/1645.short)");
	help_strings[string("dnMultiSpeciesCoalescent")][string("see_also")] = string(R"(dnMultiSpeciesCoalescentUniformPrior
dnMultiSpeciesCoalescentInverseGamma)");
	help_strings[string("dnMultiSpeciesCoalescent")][string("title")] = string(R"(Multispecies coalescent Distribution)");
	help_strings[string("dnMultiSpeciesCoalescentInverseGamma")][string("authors")] = string(R"(Sebastian Hoehna, Bastien Boussau)");
...
If you are interested in reconstructing ancestral effective population sizes, use dnMultiSpeciesCoalescent.)");
	...
	help_strings[string("dnMultiSpeciesCoalescentInverseGamma")][string("references")] = string(R"(- citation: ' Algorithmic improvements to species delimitation and phylogeny estimation
  ...
  url: http://www.indriid.com/2016/2016-06-01-STACEY.pdf)");
	help_strings[string("dnMultiSpeciesCoalescentInverseGamma")][string("see_also")] = string(R"(dnMultiSpeciesCoalescent
dnMultiSpeciesCoalescentUniformPrior)");
	...
	help_strings[string("dnMultiSpeciesCoalescentUniformPrior")][string("authors")] = string(R"(Sebastian Hoehna, Bastien Boussau)");
...
Effective population sizes can be constant across the species tree, if a single real positive is provided, or branchwise, if a vector is provided.)");
	...
	help_strings[string("dnMultiSpeciesCoalescentUniformPrior")][string("references")] = string(R"(- citation: Bayes Estimation of Species Divergence Times and Ancestral Population
    Sizes Using DNA Sequences From Multiple Loci. Bruce Rannala and Ziheng Yang. GENETICS
    August 1, 2003 vol. 164 no. 4 1645-1656.
  doi: null
  url: http://www.genetics.org/content/164/4/1645.short
...
- citation: Integration within the Felsenstein equation for improved Markov chain Monte
  ...
  url: https://www.pnas.org/content/104/8/2785)");
	help_strings[string("dnMultiSpeciesCoalescentUniformPrior")][string("see_also")] = string(R"(dnMultiSpeciesCoalescent
dnMultiSpeciesCoalescentInverseGamma)");
	help_strings[string("dnMultiSpeciesCoalescentUniformPrior")][string("title")] = string(R"(Multispecies coalescent Distribution)");
	help_strings[string("dnMultiValueEvent")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnMultiValueEvent")][string("see_also")] = string(R"(dnEvent)");
	help_strings[string("dnMultiValueEvent")][string("title")] = string(R"(MultiValueEvent Distribution)");
	help_strings[string("dnMultinomial")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnMultinomial")][string("see_also")] = string(R"(dnDirichlet)");
	help_strings[string("dnMultinomial")][string("title")] = string(R"(Multinomial Distribution)");
	help_strings[string("dnMultivariateNormal")][string("authors")] = string(R"(Sebastian Hoehna
Michael Landis)");
...
where mu is a vector of mean values and Sigma is a covariance matrix. Note, this distribution may also be parameterized in terms of the precision matrix, Sigma^-1.)");
	...
	help_strings[string("dnMultivariateNormal")][string("see_also")] = string(R"(dnNormal
dnWishart
mvCorrelationMatrixUpdate)");
	help_strings[string("dnMultivariateNormal")][string("title")] = string(R"(Multivariate Normal Distribution)");
	help_strings[string("dnNbinomial")][string("authors")] = string(R"(Walker Pett)");
	...
	help_strings[string("dnNbinomial")][string("see_also")] = string(R"(dnBinomial)");
	help_strings[string("dnNbinomial")][string("title")] = string(R"(Negative Binomial Distribution)");
	help_strings[string("dnNormal")][string("authors")] = string(R"(Sebastian Hoehna)");
...
where mu is the mean of the distribution and sigma the standard deviation.)");
	...
	help_strings[string("dnNormal")][string("see_also")] = string(R"(dnLognormal)");
	help_strings[string("dnNormal")][string("title")] = string(R"(Normal Distribution)");
	help_strings[string("dnOrnsteinUhlenbeck")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnOrnsteinUhlenbeck")][string("see_also")] = string(R"(dnBinomial)");
...
```)");
	...
	help_strings[string("dnPhyloMultivariateBrownianREML")][string("authors")] = string(R"(Michael R. May
Nicolai Vetr)");
	...
	help_strings[string("dnPhyloMultivariateBrownianREML")][string("references")] = string(R"(- citation: Huelsenbeck JP, B Rannala (2003). Detecting correlation between characters
    in a comparative analysis with uncertain phylogeny. Evolution, 57(6):1237-1247.
  doi: null
  url: null)");
	help_strings[string("dnPhyloMultivariateBrownianREML")][string("see_also")] = string(R"(dnPhyloBrownianREML
dnPhyloBrownianMVN)");
	...
	help_strings[string("dnPointMass")][string("authors")] = string(R"(Walker Pett)");
	...
	help_strings[string("dnPoisson")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnPoisson")][string("see_also")] = string(R"(dnGeom)");
	...
	help_strings[string("dnScaledDirichlet")][string("authors")] = string(R"(Andrew Magee)");
	...
	help_strings[string("dnScaledDirichlet")][string("see_also")] = string(R"(dnDirichlet
simplex)");
	...
	help_strings[string("dnSoftBoundUniformNormal")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnSoftBoundUniformNormal")][string("see_also")] = string(R"(dnUniform)");
	...
	help_strings[string("dnStudentT")][string("authors")] = string(R"(Wade Dismukes and Kevin Quinteros)");
	...
	help_strings[string("dnUniform")][string("authors")] = string(R"(Michael Landis)");
	...
	help_strings[string("dnVarianceGamma")][string("authors")] = string(R"(Michael Landis)");
...
where mu is the mean of the distribution and sigma the standard deviation.)");
	...
	help_strings[string("dnWhiteNoise")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("dnWhiteNoise")][string("see_also")] = string(R"(dnGamma)");
	...
	help_strings[string("exists")][string("authors")] = string(R"(Michael Landis)");
	...
	help_strings[string("exists")][string("see_also")] = string(R"(clear)");
	...
	help_strings[string("fnCoala")][string("authors")] = string(R"(Bastien Boussau)");
	help_strings[string("fnCoala")][string("name")] = string(R"(fnCoala)");
	help_strings[string("fnCoala")][string("references")] = string(R"(- citation: A branch-heterogeneous model of protein evolution for efficient inference
...
frequencies to vary independently.)");
	...
	help_strings[string("fnCodonGY94")][string("references")] = string(R"(- citation: Goldman, N. and Z. Yang (1994). A codon-based model of nucleotide substitution for protein-coding DNA
      sequences. Mol. Biol. Evol. (1994) 11 (5):725-736
  doi: https://doi.org/10.1093/oxfordjournals.molbev.a040153)");
	help_strings[string("fnCodonGY94")][string("see_also")] = string(R"(fnF1x4, fnF3x4, fnCodonMG94, fnCodonMG94K)");
...
frequencies to vary independently.)");
	...
	help_strings[string("fnCodonMG94")][string("references")] = string(R"(- citation: Muse, S. and B. Gaut (1994) A likelihood approach for comparing synonymous and nonsynonymous
  ...
  doi: https://doi.org/10.1093/oxfordjournals.molbev.a040152)");
	help_strings[string("fnCodonMG94")][string("see_also")] = string(R"(fnCodonMG94, fnCodonMG94K)");
...
frequencies to vary independently.)");
	...
	help_strings[string("fnCodonMG94K")][string("references")] = string(R"(- citation: Muse, S. and B. Gaut (1994) A likelihood approach for comparing synonymous and nonsynonymous
      nucleotide substitution rates, with application to the chloroplast genome. Mol. Biol. Evol. (1994) 11 (5):715-724
  doi: https://doi.org/10.1093/oxfordjournals.molbev.a040152)");
	help_strings[string("fnCodonMG94K")][string("see_also")] = string(R"(fnCodonGY94, fnCodonMG94K)");
...
so that the frequencies of non-stop codons sum to 1.0.)");
	...
	help_strings[string("fnF1x4")][string("see_also")] = string(R"(fnGY94, fnF3x4)");
	...
	help_strings[string("fnF2x4")][string("see_also")] = string(R"(fnX2)");
...
so that the frequencies of non-stop codons sum to 1.0.)");
	...
	help_strings[string("fnF3x4")][string("see_also")] = string(R"(fnGY94, fnF1x4)");
...
and the initial frequency 1/N of allele j.)");
	...
	help_strings[string("fnFMutSel")][string("references")] = string(R"(- citation: Yang, Z. and R. Nielsen. Mutation-Selection Models of Codon Substitution and Their Use to Estimate
      Selective Strengths on Codon Usage.  Mol. Biol. Evol. (2008) 25(3):568--579
  doi: https://doi.org/10.1093/molbev/msm284)");
	help_strings[string("fnFMutSel")][string("see_also")] = string(R"(fnCodonGY94, fnCodonMG94, fnFMutSel0, fnMutSel)");
...
and the initial frequency 1/N of allele j.)");
	...
	help_strings[string("fnFMutSel0")][string("references")] = string(R"(- citation: Yang, Z. and R. Nielsen. Mutation-Selection Models of Codon Substitution and Their Use to Estimate
      Selective Strengths on Codon Usage.  Mol. Biol. Evol. (2008) 25(3):568--579
  doi: https://doi.org/10.1093/molbev/msm284)");
	help_strings[string("fnFMutSel0")][string("see_also")] = string(R"(fnCodonGY94, fnCodonMG94, fnFMutSel0, fnMutSel)");
...
The exchangeRates are symmetric.)");
	...
	help_strings[string("fnGTR")][string("references")] = string(R"(- citation: Tavare, S. Some Probabilistic and Statistical Problems in the Analysis of DNA Sequences.  Lectures on Mathematics in the Life Sciences (1986). 17: 57-86
...
M := fnMixtureASRV([fnGTR(er,pi1),fnGTR(er,pi2)],weights) |> fnGammaASRV(alpha) |> fnInvASRV(p_inv))");
	...
	help_strings[string("fnHKY")][string("references")] = string(R"(- citation: Hasegawa, M. et al. Dating of the human-ape splitting by a molecular clock of mitochondrial DNA. Journal of molecular evolution (1985) 22 (2): 160-174.
...
and the initial frequency 1/N of allele j.)");
	...
	help_strings[string("fnMutSel")][string("references")] = string(R"(- citation: Yang, Z. and R. Nielsen. Mutation-Selection Models of Codon Substitution and Their Use to Estimate
      Selective Strengths on Codon Usage.  Mol. Biol. Evol. (2008) 25(3):568--579
  doi: https://doi.org/10.1093/molbev/msm284)");
	help_strings[string("fnMutSel")][string("see_also")] = string(R"(fnCodonGY94, fnCodonMG94, fnMutSelAA, fnFMutSel, fndNdS)");
...
and the initial frequency 1/N of allele j.)");
	...
	help_strings[string("fnMutSelAA")][string("references")] = string(R"(- citation: Yang, Z. and R. Nielsen. Mutation-Selection Models of Codon
      Substitution and Their Use to Estimate Selective Strengths on Codon
      Usage.  Mol. Biol. Evol. (2008) 25(3):568--579
  doi: https://doi.org/10.1093/molbev/msm284)");
	help_strings[string("fnMutSelAA")][string("see_also")] = string(R"(fnCodonGY94, fnCodonMG94, fnX3, fndNdS, fnMutSel)");
...
M := fnScale(MM, 1/MM.rate()))");
	...
	help_strings[string("fnTrN")][string("references")] = string(R"(- citation: Tamura, K. and M. Nei. Estimation of the number of nucleotide substitutions in the control region of mitochondrial DNA in humans and chimpanzees. Molecular biology and evolution (1993) 10(3):512-526.
  doi: https://doi.org/10.1093/oxfordjournals.molbev.a040023
  url: https://academic.oup.com/mbe/article/10/3/512/1016366)");
	help_strings[string("fnTrN")][string("see_also")] = string(R"(fnHKY)");
...
modular fashion.)");
	...
	help_strings[string("fnX2")][string("see_also")] = string(R"(fnX3)");
...
For example:
  ...
  (ii) MG94K = HKY85 + X3 + dNdS)");
	...
	help_strings[string("fnX3")][string("references")] = string(R"(- citation: Redelings, BD (2021). BAli-Phy version 3: Model-based co-estimation of Alignment
       and Phylogeny.  Bioinformatics (2021) 37(10):3032–3034.
  doi: https://doi.org/10.1093/bioinformatics/btab129)");
	help_strings[string("fnX3")][string("see_also")] = string(R"(fnCodonGY94, fnCodonMG94K, fndNdS)");
...
For example:
  ...
  (ii) MG94K = HKY85 + X3 + dNdS)");
	...
	help_strings[string("fndNdS")][string("references")] = string(R"(- citation: Redelings, BD (2021). BAli-Phy version 3: Model-based co-estimation of Alignment
       and Phylogeny.  Bioinformatics (2021) 37(10):3032–3034.
  doi: https://doi.org/10.1093/bioinformatics/btab129)");
	help_strings[string("fndNdS")][string("see_also")] = string(R"(fnCodonGY94, fnCodonMG94K, fnX3, fnMutSel)");
	...
	help_strings[string("getOption")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("getOption")][string("see_also")] = string(R"(setOption)");
	help_strings[string("getOption")][string("title")] = string(R"(Get a global RevBayes option)");
	help_strings[string("getwd")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("getwd")][string("see_also")] = string(R"(setwd)");
	...
	help_strings[string("ifelse")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("license")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("listOptions")][string("authors")] = string(R"(Will Freyman)");
	...
	help_strings[string("listOptions")][string("see_also")] = string(R"(setOption
getOption)");
	help_strings[string("listOptions")][string("title")] = string(R"(List global RevBayes options)");
	help_strings[string("ln")][string("authors")] = string(R"(Jordan Koch)");
	...
	help_strings[string("ln")][string("see_also")] = string(R"(log)");
...
p := logistic(x))");
	...
	help_strings[string("ls")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("ls")][string("see_also")] = string(R"(clear
exists)");
	help_strings[string("ls")][string("title")] = string(R"(List workspace content)");
	help_strings[string("mapTree")][string("authors")] = string(R"(Will Freyman
Sebastian Hoehna)");
	...
	help_strings[string("mapTree")][string("see_also")] = string(R"(consensusTree
mccTree
treeTrace
readTreeTrace)");
	...
	help_strings[string("max")][string("see_also")] = string(R"(`min`)");
	help_strings[string("max")][string("title")] = string(R"(Maximum of a set of numbers)");
	help_strings[string("maxdiff")][string("authors")] = string(R"(Will Pett)");
	...
	help_strings[string("maxdiff")][string("see_also")] = string(R"(readTreeTrace)");
	help_strings[string("maximumTree")][string("authors")] = string(R"(Bastien Boussau)");
	...
	help_strings[string("maximumTree")][string("references")] = string(R"(- citation: High-resolution species trees without concatenation. Scott V. Edwards,
...
- citation: 'Maximum tree: a consistent estimator of the species tree. Liu L, Yu L,
  ...
  url: https://link.springer.com/article/10.1007%2Fs00285-009-0260-0)");
	...
	help_strings[string("mccTree")][string("authors")] = string(R"(Will Pett
Sebastian Hoehna)");
	...
	help_strings[string("mccTree")][string("see_also")] = string(R"(consensusTree
mapTree
treeTrace
readTreeTrace)");
...
are greater than or less than that value. If the length of the vector is even, there will be no such value. In that case, the two are averaged automatically.)");
	...
	help_strings[string("median")][string("see_also")] = string(R"(`mean`)");
	...
	help_strings[string("min")][string("see_also")] = string(R"(`max`)");
...
Add random variables to the move directly (e.g. branch_rates[1], not branch_rates).WARNING: Disabling tuning disables both tuning of proposal variance and learning of empirical covariance matrix.)");
	...
	help_strings[string("mvCorrelationMatrixElementSwap")][string("authors")] = string(R"(Michael R. May)");
	...
	help_strings[string("mvCorrelationMatrixSingleElementBeta")][string("authors")] = string(R"(Michael R. May)");
	...
	help_strings[string("mvCorrelationMatrixSingleElementBeta")][string("see_also")] = string(R"(mvCorrelationMatrixSpecificElementBeta
...
for(i in 1:fossils.size())
{
	...
	help_strings[string("mvGammaScale")][string("authors")] = string(R"(Jeremy M. Brown)");
	...
	help_strings[string("mvGammaScale")][string("see_also")] = string(R"(mvScale)");
...
mymcmc.run(generations=200000))");
	...
	help_strings[string("mvLayeredScaleProposal")][string("authors")] = string(R"(Bastien Boussau)");
...
An age is randomly drawn between the root age and the age of the oldest tip. Then all subtrees below this age are scaled up or down depending on a scaler drawn from an exponential distribution.)");
	...
	help_strings[string("mvLayeredScaleProposal")][string("see_also")] = string(R"(mvSubTreeScale)");
...
mvRandomNaturalWalk)");
	...
	help_strings[string("mvResampleFBD")][string("authors")] = string(R"(Walker Pett)");
...
moves.append( mvResampleFBD(bd, weight=taxa.size()) ))");
	...
	help_strings[string("mvResampleFBD")][string("references")] = string(R"(        - citation: The fossilized birth-death model for the analysis of stratigraphic range data under different speciation modes. Stadler, Tanja et al. Journal of theoretical biology, 447:41-55.
          doi: doi.org/10.1016/j.jtbi.2018.03.005
          url: https://www.sciencedirect.com/science/article/pii/S002251931830119X)");
	help_strings[string("mvResampleFBD")][string("see_also")] = string(R"(dnFossilizedBirthDeathRange
dnFossilizedBirthDeathRangeMatrix)");
	...
	help_strings[string("mvSpeciesNarrow")][string("authors")] = string(R"(Sebastian Hoehna, Bastien Boussau)");
...
This move jointly performs narrow exchange moves (Nearest-Neighbor Interchanges without branch length alterations) on the species tree and on gene trees, all of which must be ultrametric.)");
	...
	help_strings[string("mvSpeciesNarrow")][string("references")] = string(R"(- citation: "Guided Tree Topology Proposals for Bayesian Phylogenetic Inference. Sebastian\
...
- citation: Algorithmic improvements to species delimitation and phylogeny estimation
  ...
  url: http://link.springer.com/article/10.1007/s00285-016-1034-0)");
	help_strings[string("mvSpeciesNarrow")][string("see_also")] = string(R"(mvSpeciesSubtreeScale
...
mvSpeciesTreeScale)");
	...
	help_strings[string("mvSpeciesNodeTimeSlideUniform")][string("authors")] = string(R"(Sebastian Hoehna, Bastien Boussau)");
...
This move jointly performs node time slides (branch length alterations, keeping the topologies fixed) on the species tree and on gene trees, all of which must be ultrametric.)");
	...
	help_strings[string("mvSpeciesNodeTimeSlideUniform")][string("references")] = string(R"(- citation: "Guided Tree Topology Proposals for Bayesian Phylogenetic Inference. Sebastian\
    \ H\xF6hna, Alexei J. Drummond. Syst Biol (2012) 61 (1): 1-11."
  doi: https://doi.org/10.1093/sysbio/syr074
  url: https://academic.oup.com/sysbio/article-lookup/doi/10.1093/sysbio/syr074
- citation: Algorithmic improvements to species delimitation and phylogeny estimation
  ...
  doi: https://doi.org/10.1007/s00285-016-1034-0
  url: http://link.springer.com/article/10.1007/s00285-016-1034-0)");
	help_strings[string("mvSpeciesNodeTimeSlideUniform")][string("see_also")] = string(R"(mvSpeciesSubtreeScale
mvSpeciesSubtreeScaleBeta
mvSpeciesNarrow
mvSpeciesTreeScale)");
	...
	help_strings[string("mvSpeciesSubtreeScale")][string("authors")] = string(R"(Sebastian Hoehna, Bastien Boussau)");
...
All gene-trees that are present in the population will be scaled accordingly.)");
	...
	help_strings[string("mvSpeciesSubtreeScale")][string("references")] = string(R"(- citation: "Guided Tree Topology Proposals for Bayesian Phylogenetic Inference. Sebastian\
    \ H\xF6hna, Alexei J. Drummond. Syst Biol (2012) 61 (1): 1-11."
  doi: https://doi.org/10.1093/sysbio/syr074
  url: https://academic.oup.com/sysbio/article-lookup/doi/10.1093/sysbio/syr074
- citation: Algorithmic improvements to species delimitation and phylogeny estimation
  ...
  doi: https://doi.org/10.1007/s00285-016-1034-0
  url: http://link.springer.com/article/10.1007/s00285-016-1034-0)");
	help_strings[string("mvSpeciesSubtreeScale")][string("see_also")] = string(R"(mvSpeciesNodeTimeSlideUniform
mvSpeciesSubtreeScaleBeta
mvSpeciesNarrow
mvSpeciesTreeScale)");
	...
	help_strings[string("mvSpeciesSubtreeScaleBeta")][string("authors")] = string(R"(Sebastian Hoehna, Bastien Boussau)");
...
All gene-trees that are present in the population will be scaled accordingly.)");
	...
	help_strings[string("mvSpeciesSubtreeScaleBeta")][string("references")] = string(R"(- citation: "Guided Tree Topology Proposals for Bayesian Phylogenetic Inference. Sebastian\
    \ H\xF6hna, Alexei J. Drummond. Syst Biol (2012) 61 (1): 1-11."
  doi: https://doi.org/10.1093/sysbio/syr074
  url: https://academic.oup.com/sysbio/article-lookup/doi/10.1093/sysbio/syr074
- citation: Algorithmic improvements to species delimitation and phylogeny estimation
  ...
  doi: https://doi.org/10.1007/s00285-016-1034-0
  url: http://link.springer.com/article/10.1007/s00285-016-1034-0)");
	help_strings[string("mvSpeciesSubtreeScaleBeta")][string("see_also")] = string(R"(mvSpeciesNodeTimeSlideUniform
...
mvSpeciesTreeScale)");
	...
	help_strings[string("mvSpeciesTreeScale")][string("authors")] = string(R"(Sebastian Hoehna, Bastien Boussau)");
...
This move jointly performs a tree scale move (the entire tree is scaled up or down, keeping the topology fixed) on the species tree and on gene trees, all of which must be ultrametric.)");
	...
	help_strings[string("mvSpeciesTreeScale")][string("references")] = string(R"(- citation: "Guided Tree Topology Proposals for Bayesian Phylogenetic Inference. Sebastian\
    \ H\xF6hna, Alexei J. Drummond. Syst Biol (2012) 61 (1): 1-11."
  doi: https://doi.org/10.1093/sysbio/syr074
  url: https://academic.oup.com/sysbio/article-lookup/doi/10.1093/sysbio/syr074
- citation: Algorithmic improvements to species delimitation and phylogeny estimation
  ...
  doi: https://doi.org/10.1007/s00285-016-1034-0
  url: http://link.springer.com/article/10.1007/s00285-016-1034-0)");
	help_strings[string("mvSpeciesTreeScale")][string("see_also")] = string(R"(mvSpeciesNodeTimeSlideUniform
mvSpeciesSubtreeScaleBeta
mvSpeciesNarrow
mvSpeciesSubtreeScale)");
	...
	help_strings[string("printSeed")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("printSeed")][string("see_also")] = string(R"(seed)");
	...
	help_strings[string("quit")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("range")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("range")][string("see_also")] = string(R"(seq
rep)");
	...
	help_strings[string("readTrees")][string("authors")] = string(R"(Bastien Boussau)");
	...
	help_strings[string("readTrees")][string("see_also")] = string(R"(write
...
readCharacterData)");
	...
	help_strings[string("rep")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("rep")][string("see_also")] = string(R"(simplex
v)");
	...
	help_strings[string("seq")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("seq")][string("see_also")] = string(R"(rep)");
	help_strings[string("seq")][string("title")] = string(R"(Create a sequence values)");
	help_strings[string("setOption")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("setOption")][string("see_also")] = string(R"(getOption)");
	help_strings[string("setOption")][string("title")] = string(R"(Set a global RevBayes option)");
	help_strings[string("setwd")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("setwd")][string("see_also")] = string(R"(getwd)");
	...
	help_strings[string("sqrt")][string("see_also")] = string(R"(`power`)");
...
```)");
	...
	help_strings[string("stochasticMatrix")][string("authors")] = string(R"(Michael R. May)");
	...
	help_strings[string("structure")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("structure")][string("see_also")] = string(R"(type)");
...
or `Natural`)");
	...
	help_strings[string("system")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("taxon")][string("authors")] = string(R"(Michael Landis)");
	...
	help_strings[string("taxon")][string("see_also")] = string(R"(readTaxonData)");
	help_strings[string("taxon")][string("title")] = string(R"(Taxon object)");
	help_strings[string("time")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("tmrca")][string("see_also")] = string(R"(`clade`)");
...
x ~ dnExponential(1) |> tnShift(2)   # Expressed using pipes.)");
	...
	help_strings[string("treeTrace")][string("authors")] = string(R"(Will Freyman)");
	...
	help_strings[string("treeTrace")][string("see_also")] = string(R"(mvEmpiricalTree
treeTrace
readTreeTrace
readTrees)");
	help_strings[string("trunc")][string("name")] = string(R"(trunc)");
	help_strings[string("type")][string("authors")] = string(R"(Sebastian Hoehna)");
	...
	help_strings[string("type")][string("see_also")] = string(R"(structure)");
	help_strings[string("type")][string("title")] = string(R"(The value type of a variable)");
	help_strings[string("v")][string("authors")] = string(R"(Michael Landis)");
	...
	help_strings[string("v")][string("see_also")] = string(R"(simplex
rep)");
...
Filename is specified using the `fn` argument.)");
	...
	help_strings[string("writeFasta")][string("references")] = string(R"(- citation: Pearson, William R., and David J. Lipman. "Improved tools for biological sequence comparison." Proceedings of the National Academy of Sciences 85.8 (1988): 2444-2448.
- url: https://www.pnas.org/content/85/8/2444.short
- doi: https://doi.org/10.1073/pnas.85.8.2444)");
	help_strings[string("writeFasta")][string("see_also")] = string(R"(`writeNexus`, `writeCharacterDataDelimited`)");
...
This data matrix could be a morphological matrix, a molecular matrix, or a tree.)");
	...
	help_strings[string("writeNexus")][string("references")] = string(R"(- citation: David R. Maddison, David L. Swofford, Wayne P. Maddison, Nexus: An Extensible File Format for Systematic Information, Systematic Biology, Volume 46, Issue 4, December 1997, Pages 590–621,
  doi: https://doi.org/10.1093/sysbio/46.4.590
  url: https://academic.oup.com/sysbio/article/46/4/590/1629695)");
	help_strings[string("writeNexus")][string("see_also")] = string(R"(`writeFasta`, `writeCharacterDataDelimited`, `write`)");
