...
namespace RevBayesCore {
        ...
        MatrixReal              ComputeLnProbabilitiesBackwardsLt(  const TypedDagNode<double> *start_age,
        ...
        MatrixReal              ComputeLnProbabilitiesForwardsMt(   const TypedDagNode<double> *start_age,
                                                                    const TypedDagNode<double> *lambda,
                                                                    const TypedDagNode<double> *mu,
                                                                    const TypedDagNode<double> *psi,
                                                                    const TypedDagNode<double> *omega,
