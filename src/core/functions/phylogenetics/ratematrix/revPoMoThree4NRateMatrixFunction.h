...
namespace RevBayesCore {
    ...
    public:
        revPoMoThree4NRateMatrixFunction( const TypedDagNode< long > *n, const TypedDagNode< Simplex > *bf, const TypedDagNode< RbVector<double> > *ex, const TypedDagNode< RbVector<double> > *fc   );
