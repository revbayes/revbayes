...
namespace RevBayesCore {
    ...
    namespace TreeUtilities {
        ...
        Tree*                   startingTreeInitializer(Tree& treeToChange, std::vector<Taxon>& taxaToCopy, int agePrecision);          //!< make sure starting tree satisfies age constraints, and assign min/max ages to its tips
