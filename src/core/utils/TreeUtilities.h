...
namespace RevBayesCore {
    ...
    namespace TreeUtilities {
        ...
        void                    jitter(Tree& t, double amount, bool fossils); //!< jitter node ages (and optionally fossil tip ages) just a little bit
        void                    jitterRecursively(TopologyNode& node, double amount, bool fossils);  //!< jitter the age of this node
