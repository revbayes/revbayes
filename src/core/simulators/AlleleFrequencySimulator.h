...
class Tree;
    ...
    public:
        ...
        void                                            simulateAlleleFrequencies( const std::string& fn ) const;
        
    private:
        
        void                                            simulate( const TopologyNode& n, const std::vector<long>& states, std::vector<std::vector<int> >& taxa ) const;
