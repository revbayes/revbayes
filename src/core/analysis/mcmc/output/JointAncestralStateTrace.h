...
class Tree;
    ...
    public:
        ...
        Tree*                                       cladoAncestralStateTree(const Tree &inputTree, std::string summary_stat, size_t num_states, int site, bool conditional, bool joint, bool verbose);
        Tree*                                       cladoAncestralStateTree2(const Tree &inputTree, std::string summary_stat, size_t num_states, int site, bool conditional, bool joint, bool verbose);
        void                                        summarizeCharacterMaps(Tree inputTree, const path& filename, bool verbose, std::string separator, bool bwd_time = true);
    ...
    private:
        ...
        void                                        computeMarginalCladogeneticStateProbs2(std::vector<double> pp, std::vector<std::string> states, std::vector<double>& best_pp, std::vector<std::string>& best_states, size_t num_states);

        std::vector< std::pair<size_t, double> >    parseSIMMAPForNode(std::string character_history, bool bwd_time);
