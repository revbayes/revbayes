...
//        virtual void                            run(size_t g) = 0;
        ...
        virtual void                            initializeSamplerFromCheckpoint(bool priorOnly=false, bool suppressCharacterData=false) = 0;                  //!< Initialize the values from the checkpoint file
        virtual void                            initializeSampler(bool priorOnly=false, bool suppressCharacterData=false) = 0;                                //!< Initialize objects for mcmc sampling
