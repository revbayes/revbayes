...
namespace RevBayesCore {
	...
	public:
		...
		virtual LogDensity addEvent(double time) = 0;                             //!< draw a random event at time t, return the probability of the event
		virtual LogDensity removeEvent(double time) = 0;                          //!< remove the event at time t, return the probability of the event
