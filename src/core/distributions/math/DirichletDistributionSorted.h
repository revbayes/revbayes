#ifndef DirichletDistributionSorted_H
#define DirichletDistributionSorted_H
...
*
*/
    class DirichletDistributionSorted : public TypedDistribution< Simplex > {

        public:
                                                        DirichletDistributionSorted(const TypedDagNode< RbVector<double> > *l);
            virtual                                    ~DirichletDistributionSorted(void);                                                //!< Virtual destructor
            DirichletDistributionSorted*                      clone(void) const;                                                          //!< Create an independent clone
