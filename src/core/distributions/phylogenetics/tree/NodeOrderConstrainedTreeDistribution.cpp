 ...
 */
void NodeOrderConstrainedTreeDistribution::invalidateSpecialization(const DagNode *affecter, bool fullyInvalidateSelf)
{
 ...
 */
void NodeOrderConstrainedTreeDistribution::snapshotSpecialization(void)
{
