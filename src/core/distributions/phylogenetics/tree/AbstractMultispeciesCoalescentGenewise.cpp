...
AbstractMultispeciesCoalescentGenewise::AbstractMultispeciesCoalescentGenewise(const TypedDagNode<Tree> *sp, const std::vector<Taxon> &t, size_t ngt) : TypedDistribution<Tree>( NULL ),
    taxa( t ),
    species_tree( sp ),
    num_taxa( taxa.size() ),
...
void AbstractMultispeciesCoalescentGenewise::attachTimes(Tree *psi, std::vector<TopologyNode *> &tips, size_t index, const std::vector<double> &times) {
 ...
 */
void AbstractMultispeciesCoalescentGenewise::setValue(Tree *v, bool f )
{
