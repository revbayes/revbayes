 ...
 * \param[in]    tn             Taxa.
 */
PiecewiseConstantFossilizedBirthDeathRangeProcess::PiecewiseConstantFossilizedBirthDeathRangeProcess(const TypedDagNode<double> *ra,
 ...
 *
 */
double PiecewiseConstantFossilizedBirthDeathRangeProcess::computeLnProbabilityDivergenceTimes( void ) const
{
...
double PiecewiseConstantFossilizedBirthDeathRangeProcess::getAnageneticSpeciationRate( size_t index ) const
{
...
double PiecewiseConstantFossilizedBirthDeathRangeProcess::getSymmetricSpeciationProbability( size_t index ) const
{
...
double PiecewiseConstantFossilizedBirthDeathRangeProcess::lnProbTreeShape(void) const
{
 ...
 *
 */
void PiecewiseConstantFossilizedBirthDeathRangeProcess::simulateClade(std::vector<TopologyNode *> &n, double age, double present)
{
 ...
 */
double PiecewiseConstantFossilizedBirthDeathRangeProcess::simulateDivergenceTime(double origin, double present) const
{
...
int PiecewiseConstantFossilizedBirthDeathRangeProcess::updateStartEndTimes( const TopologyNode& node ) const
{
    if( node.isTip() )
    {
 ...
 *
 */
void PiecewiseConstantFossilizedBirthDeathRangeProcess::updateIntervals() const
{
