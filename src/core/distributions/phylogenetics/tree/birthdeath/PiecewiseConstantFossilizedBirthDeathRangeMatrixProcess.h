#ifndef PiecewiseConstantFossilizedBirthDeathRangeMatrixProcess_H
#define PiecewiseConstantFossilizedBirthDeathRangeMatrixProcess_H
...
namespace RevBayesCore {
     ...
     *
     */
    class PiecewiseConstantFossilizedBirthDeathRangeMatrixProcess : public TypedDistribution<MatrixReal>, public AbstractPiecewiseConstantFossilizedRangeProcess {
        
    public:
        PiecewiseConstantFossilizedBirthDeathRangeMatrixProcess (const DagNode *speciation,
        ...
        PiecewiseConstantFossilizedBirthDeathRangeMatrixProcess*   clone(void) const;                                         //!< Create an independent clone
