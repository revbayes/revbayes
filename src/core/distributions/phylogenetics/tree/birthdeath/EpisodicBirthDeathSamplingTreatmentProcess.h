...
namespace RevBayesCore {
    ...
    protected:
        ...
        bool                                            countAllNodes(void);                                                //!< Count bifurcating nodes, count all heterochronous nodes as either phi- or Phi-sampled and as either sampled ancestors or sampled extinct tips
