 ...
 */
void StateDependentSpeciationExtinctionProcess::invalidateSpecialization(const DagNode *affecter, bool fullyInvalidateSelf)
{
 ...
 */
void StateDependentSpeciationExtinctionProcess::snapshotSpecialization(void)
{
