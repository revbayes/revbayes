 ...
 */
void OccurrenceBirthDeathProcess::countAllNodes(void) const
{
  // get node/time variables
  size_t num_nodes = value->getNumberOfNodes();
...
//  * Compute D_i(t)
//  */
// double OccurrenceBirthDeathProcess::D(size_t i, double t) const
// {
//   // D(0) = 1
//   if ( t < DBL_EPSILON )
//   {
 ...
 * Compute ln(D_i(t))
 */
double OccurrenceBirthDeathProcess::lnD(size_t i, double t) const
{
    // D(0) = 1
    if ( t < DBL_EPSILON )
    {
 ...
 * Compute E_i(t)
 */
double OccurrenceBirthDeathProcess::E(size_t i, double t) const
{
  // E_{-1}(0) = 1
  // if ( t < DBL_EPSILON )
  // {
 ...
 */
double OccurrenceBirthDeathProcess::modifiedE(int i, double t, size_t condition_type) const
{
  if (i < 0) {
    if ( t < DBL_EPSILON )
    {
...
// double OccurrenceBirthDeathProcess::lnProbNumTaxa(size_t n, double start, double end, bool MRCA) const
// {
 ...
 */
int OccurrenceBirthDeathProcess::survivors(double t) const
{
 ...
 */
int OccurrenceBirthDeathProcess::whichIntervalTime(double t) const
{
