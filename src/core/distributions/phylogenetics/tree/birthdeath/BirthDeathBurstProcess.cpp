 ...
 *
 */
LogDensity BirthDeathBurstProcess::computeLnProbabilityDivergenceTimes( void ) const
{
 ...
 */
LogDensity BirthDeathBurstProcess::computeLnProbabilityTimes( void ) const
{
