...
//     std::unordered_map<RbBitSet,std::vector<double> > node_age_params = parameters.getEdgeLengthDistributionParameters();
...
//     std::unordered_map<RbBitSet,std::vector<double> > node_age_params = parameters.getNodeTimeDistributionParameters();
