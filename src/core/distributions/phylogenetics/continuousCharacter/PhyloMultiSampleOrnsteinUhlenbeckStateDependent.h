...
namespace RevBayesCore {
    ...
    private:
        ...
        double                                                                  computeStateDependentAlpha(size_t state_idx) const;
        double                                                                  computeStateDependentSigma(size_t state_idx) const;
        double                                                                  computeStateDependentTheta(size_t state_idx) const;
        double                                                                  computeMeanForSpecies(const std::string &n, size_t i);
        double                                                                  simulateEpisode(size_t state_idx, double delta_t, double ancestral_value);
        double                                                                  computeEpisodeMean(double mu, size_t state_idx, double time);
        double                                                                  computeEpisodeScalingFactor(double log_nf, size_t state_idx, double time);
        double                                                                  computeEpisodeVariance(double var, size_t state_idx, double time);
