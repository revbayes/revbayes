...
namespace RevBayesCore {
    ...
    public:
        PhyloCTMCSiteHomogeneous(const TypedDagNode< Tree > *t, size_t nChars, bool c, size_t nSites, bool amb, bool internal, bool gapmatch, bool invert);
...
template<class charType>
RevBayesCore::PhyloCTMCSiteHomogeneous<charType>::PhyloCTMCSiteHomogeneous(const TypedDagNode<Tree> *t, size_t nChars, bool cmprss, size_t nSites, bool amb, bool internal, bool gapmatch, bool invert) : AbstractPhyloCTMCSiteHomogeneous<charType>(  t, nChars, 1, cmprss, nSites, amb, internal, gapmatch, invert )
{
