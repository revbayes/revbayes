...
EpochCoalRateMatrixDemography::EpochCoalRateMatrixDemography(const TypedDagNode< RbVector<double> > *n,
...
EpochCoalRateMatrixDemography::~EpochCoalRateMatrixDemography( void )
{
...
//bool EpochCoalRateMatrixDemography::calculateExpectedSFS(void) const
//{
//
...
EpochCoalRateMatrixDemography* EpochCoalRateMatrixDemography::clone( void ) const
{
    return new EpochCoalRateMatrixDemography( *this );
}


double EpochCoalRateMatrixDemography::computeLnProbability( void )
{
...
void EpochCoalRateMatrixDemography::executeMethod(const std::string &name, const std::vector<const DagNode *> &args, RbVector<double> &rv) const
{
...
void EpochCoalRateMatrixDemography::initialize( void )
{
...
void EpochCoalRateMatrixDemography::redrawValue( void )
{
...
void EpochCoalRateMatrixDemography::swapParameterInternal(const DagNode *oldP, const DagNode *newP)
{
